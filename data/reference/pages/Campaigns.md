...
Source: https://en.uesp.net/wiki/Online:Campaigns
Fetched: 2026-09-12
License: CC BY-SA, UESP

To access Cyrodiil and Alliance vs Alliance PvP, you must first select a Campaign. These are self-contained instances, and the state of the war differs between them. While the physical landscape is the same, each campaign holds different people and has differing rules. Generally, there are six Cyrodiil campaigns and two Imperial City campaigns available for players to join; however, more campaigns are added during events such as Whitestrake's Mayhem.
...
## Rulesets
There are currently three permanent rulesets for Cyrodiil, each of which has its own campaign.

Currently, the Alliance Locked ruleset is the most commonly played ruleset. In this ruleset, when players join the campaign, they have 5 minutes to leave before they are locked to that character's faction, and can only play for the faction that they are locked to for the duration of the campaign.

Another ruleset is Standard, which is similar to Alliance Locked, but without the faction lock, meaning players can swap factions without waiting for the campaign to end.

The last ruleset is Vengeance, which was made to test performance in large scale battles. In this ruleset, players are given equal stats, the regular skill lines are replaced by their Vengeance versions (which don't include passive skills), the Champion system, Volendrung and armor sets are disabled, there are Loadouts and Perks and the players are supplied with unlimited siege equipment, potions, soul gems and recall stones with a separate inventory tab.

Imperial City has two rulesets - one with Champion Points enabled, and one without. Imperial City campaign rulesets do not have a duration, as they do not have leaderboards.

## Home Campaign
While players can join any campaign, players also have the option to set a campaign as their home campaign. In a player's home campaign, they will be placed on a leaderboard based on how many Alliance Points (AP) they have earned over the duration of the campaign. This list can be filtered by alliance and class. If all six keeps around the Imperial City are claimed by one alliance, the player at the top of that alliance's leaderboard will be crowned Emperor of that campaign. The Emperor is deposed if that alliance loses control of all six keeps, or sets another campaign as their home.
...
colspan="3" | Ownership of home objectives gives double

Gray Host
#F3CCB2| All Levels Champion Passives Enabled Alliance Locked
rowspan="3" | 30 days
rowspan="4" #BCF5B3| 5
rowspan="4" #BCF5B3| 1
rowspan="4" #BCF5B3| 1
...
Blackreach
#F3CCB2| All Levels Champion Passives Enabled

Vengeance
#F3CCB2| All Levels Champion System Disabled No Armor Sets Vengeance Skills Loadouts Perks
...
Legion Zero
#F5E9B3| All Levels No Champion Passives

No-CP Imperial City
lightgray| All Levels No Champion Passives
...
colspan="4" | 7-Day Campaigns

Tier 1 (25k-49.9k)
Tier 2 (50k-99.9k)
Tier 3 (100k+)

rowspan="2" | 1st Place Alliance
2100 gold
3000 gold + 1 Superior item
3900 gold + 1 Epic item

colspan="3" | 1 Transmutation Geode + 20 Keep Wall Masonry Repair Kits

rowspan="2" | 2nd Place Alliance
1375 gold
1750 gold
2125 gold

colspan="3" | 1 Transmutation Geode + 10 Keep Wall Masonry Repair Kits

rowspan="2" | 3rd Place Alliance
950 gold
1100 gold
1250 gold

colspan="3" | 1 Transmutation Geode + 5 Keep Wall Masonry Repair Kits

colspan="4" | 30 Day Campaigns
...
rowspan="2" | 1st Place Alliance
10500 gold
15000 gold + 5 Superior items
19500 gold + 5 Epic items
...
Top 2% on Leaderboard in Alliance
3000 gold + 1 Legendary item + 2 Transmutation Geodes
15000 gold + 5 Legendary items + 2 Transmutation Geodes

Top 3-10% Leaderboard in Alliance
1500 gold + 1 Epic item + 2 Transmutation Geodes
7500 gold + 5 Epic items + 2 Transmutation Geodes
...
Emperorship Alliance Bonus | Emperorship Alliance Bonus I | Increases Max Health by 900.

Emperorship Alliance Bonus | Emperorship Alliance Bonus II | Increases Max Health by 1050.

Emperorship Alliance Bonus | Emperorship Alliance Bonus III | Increases Max Health by 1250.

Emperorship Alliance Bonus | Emperorship Alliance Bonus IV | Increases Max Health by 1400.

Emperorship Alliance Bonus | Emperorship Alliance Bonus V | Increases Max Health by 1600.

Emperorship Alliance Bonus | Emperorship Alliance Bonus VI | Increases Max Health by 1750.

## Performance Tests
In July of 2020, Zenimax announced that with the release of Update 27 they would be conducting several tests in Cyrodiil to pinpoint the source of lag spikes in Cyrodiil. They attributed these lag spikes to be from how the server handles AOEs, and announced that a series of tests would be conducted to isolate these variables. These tests only took place in Cyrodiil and players were awarded double Alliance Points for participating in these tests. Below are the initial wave of tests conducted, the date they were conducted, and how they effected combat.
...
### Wave 2
In October of 2020, Zenimax announced that there would be 2 more weeks of tests. This second wave of tests were combinations of previous tests, and were designed to determine how multiple rules would affect Cyrodiil, as the individual tests conducted in wave 1 did not show a significant impact in performance. They were to disable all tests and double AP by the release of Update 28 for PC on November 2, 2020. The conditions of the second wave of tests are listed below.
...
### Server Recoding
In January 2022, Zenimax Online Studios ESO Game Director Matt Firor published a [https://forums.elderscrollsonline.com/en/discussion/595442/eso-pvp-update-january-2022/p1|a post] to the official forums following up on the results of the tests and other efforts to address performance issues in Cyrodiil. In it, it was announced that the developers would be rewriting the foundational code used by the game servers with particular attention to server responsiveness in Player versus Player environments and other high-intensity gameplay scenarios.
...
### Vengeance
From March 24th to March 31st, June 30th to July 7th, September 22nd to September 29th, December 3rd to December 15th of 2025, April 20th to April 27th of 2026, the Vengeance Campaign opened to live servers and only this campaign was available for Cyrodiil. On June 8th of 2026, the Vengeance campaign was permanently made available alongside Gray Host and Blackreach, while Ravenwatch and Icereach were shut down. This campaign was made to test performance. The rules were as follows:

- Sets, Weapons, Armors, Attributes, Champion Points, Mundus Stones, Skills, Consumables, Quests, Crafting and Service Merchants were all disabled during this campaign. Timed Buffs such as from food and experience scrolls were halted and disabled until you exited the campaign. You had no access to your original inventory (including Currency and Craft Bag) while in the campaign, it was of course returned to you once you left the campaign.

- All players were given equal stats and were given a Soul Gem of Vengeance, "Vengeance" siege weapons, a Cyrodiil Repair Kit of Vengeance, a "Vengeance" Forward Camp and a Tri-Restoration Potion of Vengeance which all could be used infinitely:
- 70,000 Health and 500 Health Recovery
- 30,000 Magicka and Stamina
- 2,200 Magicka Recovery and 1,500 Stamina Recovery
- 5,000 Weapon Damage and Spell Damage
- 30% Weapon Critical and Spell Critical
- 16,133 Physical Resistance and Spell Resistance
- 1,650 Critical Resistance
- Block: 1,750 cost, 50% mitigation and 40% move speed
- Bash: 765 cost and 363 damage
- Dodge Roll: 4,040 cost
- Break Free: 5,400 cost
- Sneak: 133 cost and 60% speed
- Sprint: 500 cost and 140% speed
- Critical Damage and Critical Healing: Base 50% bonus
- All Players were given level 50 CP-0 equipment and the only skills available were special "Vengeance" simplified variations of class skills.
- During the second test, Vengeance versions of the Weapon and Alliance War skills added.
- During the third test, Vengeance versions of the Mages Guild and Fighters Guild skills were added.
- During the fifth test, Vengeance versions of the three Armor skills were added and combined into a single skill line.

- The fourth Vengeance test introduced Loadouts and Perks, to allow swapping between pre-made builds and adjusting various stats in the Vengeance campaign.
...
- The permanent Vengeance iteration added with Update 50 introduced skill lines for the Soldier, Vanguard, Battle Medic and Scout Loadouts, with each skill line having one Ultimate and five Active Abilities.

- The seventh test that ran from July 20 to July 27, 2026 allowed proc effects from armor sets. Grey Host and Blackreach were shut down for the duration of this test.

- Alliance Points and Experience Points earned were given upon leaving the campaign but it still showed when you gained while in the campaign.

- No leaderboard, no Emperor.

- The Alliance War bonuses you could get were Home Keep and Enemy Keep Bonuses, Scroll Bonuses and Blessing of War. Battle Spirit and Edge Keep Bonuses were disabled. Riding Skill still worked. Your Quickslot wheel was unique to Vengeance and you could slot Vengeance items in it, upon leaving your original Quickslot wheel was returned to you.

- Locations all appeared as undiscovered, rediscovering them didn't grant Experience Points but now could be seen on your map. All Mages Guild Books appeared whether you already read them or not but weren't interactable, same with Eidetic Memory books glowing whether you already read them or not. Resource Nodes appeared but could not be harvested. Treasure Chests appeared but couldn't be opened due to the lack of Lockpicks. Killing mobs only gave gold and Experience points.

- NPCs had No-CP stats and benefited from Keep Upgrades and Resource Upgrades.

- ESO Plus bonuses were still active.

- You could claim keeps for a guild but the guild trader was mostly disabled. You could still see a bit of what the guild was selling in the first test, but not in the second one.

- Though Subclassing was out before the 2nd test, it wasn't implemented in it.

- Your Vengeance skill bars and Vengeance quickslot wheel were saved between tests.
...
; Active Campaigns
: Cyrodiil: Gray Host, Blackreach, Vengeance
...
: ChillrendAlso on PC? (7 day Scrolls, console only)
...
: Skull of Corruption, ThornbladeAlso PC-NA 30 day? (console only, 7 day duration)
...
: Ravenwatch (30 day duration, no CP)
: Icereach (7 day duration, below 50)
;Unreleased Campaigns
The following are campaign names derived from the.LANG file that have yet to appear:
: (Artifacts) Oghma Infinium, Orb of Vaermina, Fists of Randagulf, Eye of Nocturnal, Flask of Lillandril, Fearstruck, Warlock's Ring, Witsplinter, Rueful Axe, Robe of the Lich, Ring of Sunfire, Mehrunes' Razor, Mace of Aevar, Lord's Mail, Hrormir's Icestaff, Judgment of Veloth
