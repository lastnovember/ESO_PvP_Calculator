...
Source: https://en.uesp.net/wiki/Online:Companions
...
Bastian's Insight: Potions looted from monsters have a 30% chance to be improved by Bastian's Insight.
...
rowspan="2" | Necrom
The Fateweaver Key
Azandar's Inquisitiveness: When searching containers, it bestows a chance to discover research portfolios. Portfolios can contain crafting recipes, treasure maps, research notes, survey reports, and other documents of value.
...
Tanlorin
Non-Binary
Dragonknight Dragonknight (with Soul Magic)
Altmer High Elf
Spirited: Decreases damage taken by 3% and increases damage done by 3%.
rowspan="2" | Crown Store
The Garland Ring
Tanlorin's Finesse: When lockpicking, it bestows an increased time to pick a lock, an increased chance to force a lock, and a reduced chance to break a lockpick.
...
A Moonlit Shadow
Zerith's Guidance: Ja'kh uses his keen eyes to point out heavy sacks.

A player may have only one Companion or Assistant active at a time; summoning a Companion will also unsummon any active Assistant and vice versa. Summoning a Companion takes several seconds for them to appear, during which no other Companion or Assistant may be summoned. Unlocked Companions may be assigned to a slot on the quick-slot wheel for ease of switching.
...
Players will always take priority, and Companions will be auto-dismissed as players zone in. Companions cannot be summoned in PvP areas, solo arenas or in housing instances. They also cannot be summoned if the summoning character has not yet completed the associated introductory quest, even if the collectible has been unlocked by another character.

Companions cannot normally be summoned while you are in combat, but if you summon a non-Companion assistant (such as a banker or merchant), they will replace your current Companion, and when you put the assistant away, the Companion will return, even if you are in combat. Note that this can happen even if your Companion falls in battle, and this can be a quick way to get them back without having to resurrect them as normal. You may not use this method to switch to a different Companion in combat.
...
### Combat Level
Companions are level 1 when unlocked, with a limited set of ability bar slots and a maximum potential level of 20. Companions level up via a percentage (30% + Rapport Bonus), rounded up, of non-Enlightenment experience gained with your character directly from combat.
...
Ardent Warrior Draconic Armor Radiating Heart
Deadly Assassin Living Shade Soul Thief
Lightning Caller Mischievous Caster Playful Schemer
Blazing Might Brilliant Shield Healing Grace
Quill Knight Revitalizing Researcher Scholar of Apocrypha
Beasts of the Hunt Verdant Growth Winter's Bite
Draconic Armor Empathic Fighter Radiating Heart
Guardian's Commitment Remedy of Atonement Warrior's Banishment
...
1000 | 1999 | Friendly | Companion respects you as an ally. (40% companion experience bonus)

2000 | 2999 | Close | Companion greatly admires you (50% companion experience bonus)

3000 | 3999 | Allied | Companion holds you in high esteem. (60% companion experience bonus)

4000 | 5500 (max) | Companion | Companion regards you as their greatest ally and dearest friend. (70% companion experience bonus)
...
- Bastian begins wearing Medium Armor and an Inferno Staff.
- Mirri starts off with Light Armor and a Bow.
- Ember starts off with Medium Armor and a Lightning Staff.
- Isobel starts off with Heavy Armor, a Sword and a Shield.
- Azandar starts off with Light Armor and a Restoration Staff.
- Sharp starts off with Medium Armor and two One Handed Axes.
- Zerith-var starts off with Heavy Armor and a Two Handed Sword.
- Tanlorin starts off with Medium Armor and two Daggers.
...
Basic Companion equipment can be purchased from Weaponsmith, Woodworker, Armorer, Leatherworker, and Tailor merchants throughout the world, allowing you to customize your Companion role accordingly.

Fine, superior and epic quality Companion equipment with traits are obtained from monster drops throughout the world, particularly from bosses. This equipment can be traded so it can be bought and sold on the market.

Legendary Companion equipment exists, but so far there have only been two such items: a unique Companion's Ascendant Ring released as part of a one-time special event, and a Companion's Ring with a random trait acquired during Hearts Week.
...
Completing the final Companion quest will unlock a houseguest collectible of the Companion, allowing them to be placed and utilized similarly to other houseguest collectibles. Note that the houseguest version will be wearing a unique outfit, rather than whatever outfit or costume you've customized them with.
...
By default, hold Y and left click on mouse and keyboard, or press L3+R3 along with the left bumper on gamepad will direct them to attack the targeted enemy. They will also attack an enemy if you use a Heavy Attack or Ultimate skill against them.

Hold Y and right click on mouse and keyboard, or press L3+R3 along with the right bumper on gamepad will direct them to hold back and stop attacking anything.
...
## Buffs to Companions
Companions have a hidden 90% damage reduction while in the Infinite Archive.

The following armor sets help amplify your companions:
- Shared Burden - When you enter combat, 6% of the damage you take is transferred to your Companion instead. Reduce the damage your Companion takes by 0-16%. When your Companion dies in combat, they will automatically revive themselves after 12 seconds.
- Telvanni Efficiency - While you have a living companion, reduce the cooldown of their abilities by 50%.

## Notes
- For April Fools' Day 2023, a [https://www.elderscrollsonline.com/en-us/news/post/63933 joke article] was published on the ESO website announcing Stuga as an upcoming Companion.
