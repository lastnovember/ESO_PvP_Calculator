# Online:Azandar al-Cybiades/Rapport

Source: https://en.uesp.net/wiki/Online:Azandar_al-Cybiades/Rapport
License: CC BY-SA, UESP

+ Ways for Azandar to lose or gain rapport
Amount | Action | Cooldown

colspan="4" style="text-align:center; background-color:#A9E48F;" | Actions that lead to gaining Rapport
...
+5 | Complete an Oblivion PortalAppears to give +3 heart rapport, not +2 | No cooldown
...
colspan="4" style="text-align:center; background-color:#E4A08F;" | Actions that result in losing Rapport
...
-5 | Consume a beverage with Coffee
