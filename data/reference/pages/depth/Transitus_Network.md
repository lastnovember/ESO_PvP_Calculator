# Online:Transitus Network

Source: https://en.uesp.net/wiki/Online:Transitus_Network
...
- Border Keeps - These form the roots of the network. Each Alliance has two, and they cannot be taken over by other Alliances. They also provide all of the services for that Alliance within Cyrodiil, and transport back to the PvE areas. Each Border Keep is connected to a Gate Keep, an Outer Keep, and the other Border Keep for its Alliance. Only the home Alliance can use these links.
- Gate Keeps - These are the last line of defense over the Artifact Gates, and therefore the Scroll Temples. They are generally the most well-defended, and least likely to change hands (at least not for very long) over the course of a campaign. Each is connected to one of the Border Keeps, as well as the Hub Keep for its Alliance. Only the home Alliance can use these links.
- Hub Keeps - Each Alliance controls one Hub Keep. These form a critical connection between the Border Gate and Gate Keeps, and the Ring Keeps around the Imperial City. By default, they are surrounded by other Keeps of the same Alliance, two Gate Keeps, and two Ring Keeps. This makes them difficult to attack without first taking out some of the surrounding Keeps. The links to the Gate Keeps can only be used by the home Alliance, but all Alliances can use the links to the Ring Keeps.
...
Border Keeps
Eastern Elsweyr Gate Western Elsweyr Gate
Northern High Rock Gate Southern High Rock Gate
Northern Morrowind Gate Southern Morrowind Gate

Gate Keeps
Castle Black Boot Castle Bloodmayne
Fort Rayles Fort Warden
Farragut Keep Kingscrest Keep
...
Ring Keeps
Castle Alessia Castle Roebeck
Fort Aleswell Fort Ash
Blue Road Keep Chalman Keep
...
Outposts
Nikel Outpost Carmala Outpost
Bleaker's Outpost Winter's Peak Outpost
Sejanus Outpost Harlun's Outpost
