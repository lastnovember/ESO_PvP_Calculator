# Online:Heavy Armor (Companion)

Source: https://en.uesp.net/wiki/Online:Heavy_Armor_(Companion)
License: CC BY-SA, UESP

Heavy Armor is one of three armor skill lines available to Companions.

## Skill Perks
The Heavy Armor skill line is immediately available to Isobel Veloise and Zerith-var, who start their progress at level 3. Other Companions can unlock the skill line by equipping them with 3 pieces of Heavy Armor. The skill line can be leveled up from earning combat XP while your active Companion has at least 5 pieces of Heavy Armor equipped.
Notes
...
### Passive Ability
The Passive ability is active all the time; it provides a benefit per piece of Heavy Armor equipped, so it is effectively always on (with a value that can be 0).
