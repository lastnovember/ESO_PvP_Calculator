...
Source: https://en.uesp.net/wiki/Online:Scrying
...
TOC 2D
row1_header=Overview|row1_content=Passive Abilities • Advancement
row2_header=How to Scry|row2_content=Collecting Leads • Minigame • Success
row3_header=Scrying Tools|row3_content=Scry • Coalescence • Dilation • Farsight
row4_header=Difficulty Levels|row4_content=Simple and Intermediate • Advanced • Master • Ultimate
row5_header=Other Info|row5_content=Notes • Bugs
footer=Excavation • Scrying • Antiquity Leads • Antiquities by Zone
...
### Collecting Leads
tab]]
So long as the player is in an open world location, and not an instanced area such as a Dungeon, Outlaws Refuge, or the Greymoor Caverns, they can Scry a small selection of infinitely-cycling Antiquities. Alternatively, while adventuring through the world, they may collect Leads. Note that collecting leads is indiscriminate of owned DLC, so you may get a lead for something you can't even scry. Indeed, you can collect leads even if you don't own the Greymoor Chapter and hence cannot access scrying.
...
The other headers are of the major content zones: through them, you can see how many Antiquities are located in the zone, which Antiquities you have already found Leads for, and the number of codex entries each has so far. As a general rule of thumb, each Zone has one Simple, Intermediate, and Advanced Treasure, the latter of which is only obtainable once; they will appear once you have a sufficient Antiquarian Insight Rank and, for all but the former, after you Excavate an Antiquity of a lower quality.
...
### Trivial
There is only one Trivial level antiquity, which is encountered during the tutorial. There are three different facet types, and only one Focus to discover. Since you do not have the more advanced skills yet, you can only use the basic Scry activity. Depending upon the arrangement of the facets, it may take between 1 and 5 turns to reach the Focus.
...
, with two visible uses of Coalescence]]
...
## Notes
- Despite the player getting both skill lines at the same time, and the two skills levelling with one another, Excavation and Scrying may not hit max level at the same time.
- In the case of Excavation leveling faster, this may occur when you cause too much damage to the antiquity and are forced to start the excavation over again.
- In the case of Scrying leveling faster, this can happen when you fail to get all the foci in your first attempt, and scry again in order to try and get a better result.
- It's also possible to scry for a lead on one character, and then dig it up on another, which would give Scrying experience to the first and Excavation experience to the second, putting them both out of sync.
- If you update your scry progress by grabbing a dead-end Antiquity spot, then update it again by re-scrying, the dead-end Antiquity site may reappear in the Scry update.
- You can use this knowledge to either grab another Treasure from the same dig site or check the others for the Antiquity spot.
- You can completely bypass the Scry success animation by pressing the Escape key after a. you collect all six Foci; or b. you reach your last turn.
- If you manage to press it too early, it will only have the Scry cancellation window appear.
- You can only have five Antiquities scried at any one time.
- Once you achieve level 10 in the Scrying and Excavation skill line, Simple and Intermediate leads will be the same difficulty as Advanced leads to scry.

## Bugs
Dungeon]], the action may cancel your Scry entirely.
- Make sure you see "Scrying Progress Updated" on your HUD before accepting any invites, as the Scry is not registered as "completed" until then.
If you hide the UI during a Scry, the Scry interface may disappear alongside it, showing the Antiquarian's Eye's model underneath.
- Unhiding the UI typically fixes this issue, as it's mostly a visual bug.
