...
Source: https://en.uesp.net/wiki/Online:Character_Creation
...
- Your Class U
- Your Appearance T
- Your Hair Style, Facial Hair, Head Markings, Body Markings, Major Adornments, and Minor Adornments C
...
style="text-align:center;"| Daggerfall Covenant
style="text-align:center;"| Aldmeri Dominion
style="text-align:center;"| Ebonheart Pact

style="padding:0px 25px;"| Breton
style="padding:0px 25px;"| High Elf
style="padding:0px 25px;"| Argonian

style="padding:0px 25px;"| Orc
style="padding:0px 25px;"| Wood Elf
style="padding:0px 25px;"| Dark Elf
style="padding:0px 25px;"| Imperial

style="padding:0px 25px;"| Redguard
style="padding:0px 25px;"| Khajiit
style="padding:0px 25px;"| Nord
...
The Templar class has both decent magical and melee capabilities. Their Aedric Spear skill line is focused on improving their melee abilities, while the Restoring Light and Dawn's Wrath skill lines primarily augment their magical powers to deal damage or heal allies.

The Warden class focuses on nature-based magic, with the Animal Companions skill line for damage-dealing and Green Balance skill line for healing, as well as a frost magic line called Winter's Embrace that focuses on mitigating incoming damage.
...
|
The Arcanist is a powerful class that channels the eldritch powers of Apocrypha. It is a versatile class, with the Herald of the Tome for damage dealing, Soldier of Apocrypha for tanking and defensive abilities, and Curative Runeforms for healing.
...
#### Body
;Body Type T: Two subsections. One is a triangular slider with three options of Muscular, Large, and Thin. This is the main factor in your character's body shape. The second is Height. Although both of these factors are largely tied to race, with Altmer being the tallest, Orcs being the bulkiest, and Bosmer being the smallest in either regard, these sliders allow players to differentiate their characters from other members of the same race.
;Features
...
:Body Marking C - Choose from a list of 24plain scars and tattoos.
...
#### Face
;Face Type T: One subsection; a triangular slider with three options of Heroic, Soft, and Angular. This is the main factor in your character's face.

;Voice T: One subsection; your choice of voice for generic sounds. There are 8 options, ranging from Voice A to Voice H.
...
### Appearance Change
An Appearance Change Token will allow you to change a character's appearance and gender, but does not allow race, name or alliance changes. These tokens cost 1000.
...
### Race Change
A Race Change Token will allow you to change a character's race as well as appearance and gender, but not their name or alliance. It does not affect style knowledge, meaning the character will retain knowledge of their original racial style. These tokens cost 3000.
...
### Alliance Change
An Alliance Change Token will allow you to change a character's alliance, but not their name, race or appearance. These tokens cost 2500.

## Notes
- Previously, players would be disconnected from the server after 5 minutes of idling on the character create screen, similar to the login screen. This results in the loss of the new character. The timer was increased to 15 minutes in Update 50.
...
File:ON-misc-Character Creation 02.jpg|Background for Morrowind
File:ON-misc-Character Creation 03.jpg|Background for Summerset
File:ON-misc-Character Creation 04.jpg|Background for Elsweyr
