# Online:Crafting Writs

Source: https://en.uesp.net/wiki/Online:Crafting_Writs
...
- Jewelry Crafting Certification (this certification requires access to Alinor in Summerset)
...
:Thieves Guild(Same as alliance message)
...
### Crafting Survey Reports
The rewards for fulfilling crafting writs, except Provisioner writs, may randomly include Survey Reports, which are similar to Treasure Maps. When you receive one, a collection of six high-yield gathering nodes are added to a specific location, identified by the symbol on the map. These high-yield nodes do not appear unless you have the corresponding survey. It is possible to be rewarded with the same report multiple times. If this occurs, the nodes will respawn after you move a distance away, and the materials may change for alchemy and enchanting surveys.

The tier of materials at the survey location will be determined by both the level of the character and the skill in the appropriate crafting line (with the exception of alchemy), with 50% of the materials being at each. If the character level and skill level match, all materials will be of the same crafting tier.

Surveys have an approximate 1 in 8 chance of dropping, regardless of level of crafting writ completed.

Surveys will drop as an "Unidentified" report of the appropriate craft, and will stack. In the unidentified form, surveys are able to be sold at guild stores as well as deposited into guild banks.

When you open the unidentified report, you can receive surveys for any zone, including zones you have never visited, though you will not receive surveys for zones you do not have access to. Once opened, the surveys are account bound.

Surveys are able to be put into the player bank, and they will stack, unlike treasure maps.
...
Blacksmithing
A Masterful Plate A Masterful Weapon (Blacksmithing)

Clothing
Masterful Leatherwear Masterful Tailoring
...
Woodworking
A Masterful Shield A Masterful Weapon (Woodworking)
...
Generally, the more complex and expensive the writ, the more vouchers you will receive. The lowest reward possible is 2 Writ Vouchers for a relatively simple and inexpensive alchemy potion. The highest reward can be several hundred Writ Vouchers for Jewelry writs, which themselves are extremely expensive to craft. Ultimately, low-reward alchemy and enchanting master writs can be more cost-effective to complete than high-reward armor, weapon and especially jewelry writs due to the cost of materials and tempers.
...
The drop rate of master writs are affected by the knowledge level of the character that completes the daily crafting quests.

For each of the crafts, the factors that affect the drop rates are:

- Alchemy - Learning all 4 traits of the base game reagents.
- Enchanting - Translate all base game runes.
- Provisioning - Learning Epic (Purple) and Legendary (Gold) Recipes.
- Blacksmithing/Clothing/Woodworking - Learning all 9 crafting traits for the appropriate craft. Learning as many complete motifs. Base game racial motifs do not count. Crown store exclusive motifs do not count.
- Jewelry - Learning all 9 jewelry traits.
...
These only affect the chance of getting any master writ, not the quality. The quality of the master writ received is random.

### Event Writs
During certain events, special festival writs have a chance to drop from event loot boxes. Writ rewards can vary between 1 and 20 Writ Vouchers, making this an opportunity for players who cannot complete Master Writs to obtain vouchers. These do not count towards any non-event achievements such as Grand Master Crafter.
- Witches Festival Writs - Witches Festival Writs were available during the 2019 and 2020 Witches Festival and required players to create Witches Festival themed food or drink.
- New Life Charity Writs - New Life Charity Writs were available during the 2018 New Life Festival and required players to create a dozen simple furnishings.
- Deep Winter Charity Writ - Deep Winter Charity Writs were available during the 2019 and 2020 New Life Festivals and required players to create a dozen simple furnishings.
- Imperial Charity Writ - Imperial Charity Writs were available during the 2020 New Life Festival.
