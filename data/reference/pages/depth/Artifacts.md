...
Source: https://en.uesp.net/wiki/Online:Artifacts
License: CC BY-SA, UESP

PvP artifacts need to be split for the purpose of better organising skill lines
...
Artifact Weapons are used in PvP.
...
Sanguine's Rose and Auriel's Bow might appear in future updates. Rich Lambert has stated that while there are plans to add more artifacts to Cyrodiil, they are still working on polishing Volendrung's functionality before introducing newer artifacts.
...
Muatra is a unique staff wielded by Vivec. It is mentioned throughout the 36 Lessons of Vivec, and Vivec holds it a number of times throughout the Morrowind Main Quest. It is not directly referred to by its name, and is called VivecSpear_Staff in the files.
...
Veloth's Judgment is wielded by Magistrix Vox during the Deshaan questline and is later seen during Songs of Sovngarde, where it is brought to Skuldafn and presented before the Ebonheart Pact leaders at the Great Moot to seal their alliance.
...
- A hostile Flame Atronach.
- A friendly Flame Atronach.
- A hostile Pig that vanishes after a few seconds.
- A hostile Skeletal Soldier.
- A immobile Skeletal Soldier statue.
- A statue.
- A gourd plant.
- Back to themselves.
...
File:ON-icon-armor-Head-Hound.png|The Hound's mask
File:ON-icon-armor-Helmet-Mane.png|Crown of the Mane
File:ON-icon-armor-Head-Wilderking.png|Wilderking Crown
File:ON-icon-armor-Head-Barbas.png|Barbas' battle helmet
...
colspan=12|Weapons and Shields

Cleaver of St. Felms | Sword of the Crusader | Stendarr's Hammer | Debaser | Ice Blade of the Monarch | Mace of Aevar Stone-Singer | Rugdumph's Sword | Staff of the Everscamp | Staff of Hasedoki | Eleidon's Ward | Shield of the Crusader | Staff of Sheogorath

Thornblade | Daedric Battleaxe | Moon-Cursed Blade | Umbra | Wings of the Queen of Bats | Wabbajack
