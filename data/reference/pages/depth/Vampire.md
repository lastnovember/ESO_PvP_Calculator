...
Source: https://en.uesp.net/wiki/Online:Vampire
...
Amount of benefits as well as disadvantages depends on the vampirism stage and on the passive abilities unlocked, but these are the basic effects of vampirism that all vampires experience.

Benefits:
- Reduced costs for vampire abilities
- Increased weapon and spell damage after leaving sneak, invisibility or mist form (from Strike from the Shadows)
- Reduced damage taken based on the missing health
- Ignored movement speed penalty while sneaking, reduced sneak cost (part of the Dark Stalker passive)
...
The ritual sites can be found in the following zones: The Rift]] 8605

### Bloodfiends
Vampirism can be contracted by fighting special Bloodfiends which only appear at night. The bloodfiends spawn rarely, and only in select locations in one zone for each faction: Bangkorai for Daggerfall Covenant, the Rift for Ebonheart Pact, and Reaper's March for Aldmeri Dominion. They spawn around 9pm and disappear at exactly 3am in-game time. There may be multiple groups of them present in the same zone at the same time.
It is not necessary to kill the bloodfiend; once bitten, you can run away, allowing other players to contract the disease from the same enemy.

### Crown Store
The Curse of Vampirism can also be bought from the Crown Store for 0 as of U49. You do not need to do the tutorial quest if you take this route, as the initial disease stage is skipped and the skill line is unlocked immediately. If you purchase a vampire bite from the Crown Store, make sure that you are logged onto the character you wish to apply the bite to when you purchase it. It will only apply to that single character.

Once you have contracted the disease, you must complete the quest Scion of the Blood Matron to fully commit yourself as a vampire. As a vampire, you will be considered undead, with one con of that being you take 20% extra damage (double from the 10% bonus from the skills in the Fighters Guild line when fighting someone with the passive Skilled Tracker.
...
### Alliances
A player can become infected in any of the 3 alliances zones, at any shrine of the vampire type. Bloodfiends will spawn in any of the alliances zones and will infect a player of any alliance.
The only alliance-related difference is the location of the shrine, where the actual quest starts.

## Curing Vampirism
To cure your vampirism, seek out Prelate Sabinus in the Mages Guild hall in Riften (Ebonheart Pact), Evermore (Daggerfall Covenant), or Rawl'kha (Aldmeri Dominion).
...
## Leveling Vampire
The Vampire skill line is completely independent of Vampirism stages and can only be increased by gaining XP naturally. Slotting Blood Scion increases leveling speed by 25.1% (26.8% if morphed). Slotting Eviscerate, Blood Frenzy, and Vampiric Drain has no effect on leveling speed.

Rank | Experience Required for Next Rank | Total Experience for Rank
...
Vampire's Hunger|
Vampire's Feast|
Vampirism (achievement)|Noxophilic Black Skill Line: Vampire
...
- Until Update 50, you had to donate a small amount of gold (693) before being cured.
...
File:ON-skill-Vampirism Stage 1 (Dark Elf female).jpg|Stage 1 Vampirism on a female Dark Elf
File:ON-skill-Vampirism Stage 2 (Dark Elf female).jpg|Stage 2 Vampirism on a female Dark Elf
File:ON-skill-Vampirism Stage 3 (Dark Elf female).jpg|Stage 3 Vampirism on a female Dark Elf
File:ON-skill-Vampirism Stage 4 (Dark Elf female).jpg|Stage 4 Vampirism on a female Dark Elf
