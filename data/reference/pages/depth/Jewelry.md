...
Pewter Necklace | 1-25

Copper Necklace | 26-50

Silver Necklace | CP10-70

Electrum Necklace | CP80-140

Platinum Necklace | CP150-160
...
Electrum Ring | CP80-140

Platinum Ring | CP150-160

Jewelry found before Update 18 followed a different progression. These items may still be found leftover from before the update, and can still be used. While it may be researched, improved, and transmuted, it may not be deconstructed.
Show
...
Turquoise Ring | 26-35

Emerald Ring | 36-45

Ruby Ring | 45-50

Diamond Ring | 50-CP160

## Traits
Before Update 18, Jewelry could not be researched to learn its traits. However, each piece of Jewelry typically came with one trait already on it. This remains true for the most part. The standard traits are:
...
- A necklace can be obtained as a reward for completing the quest The Long Way Home.
- Triune - Increase Maximum Health, Maximum Magicka and Maximum Stamina by 435
- Rare reward from daily board quests in Cyrodiil.
- A ring can be obtained as a reward for completing the quest Uxark's Treasure.
- A ring can be obtained as a reward for completing the quest A Father's Pride
- Protective - Increase Physical Resistance by 1844
- Reward for completing major quest lines in Summerset (Psijic Order for necklace and main quest for ring).
- A necklace can be obtained as a reward for completing the quest Reformatory Rescue.
- A ring can be obtained as a reward for completing the quest The All Flags Curse.
- Swift - Increase Movement Speed by 6%
- Rare reward for Jewelry Crafting Writs.
- A ring can be obtained as a reward for completing the quest Path of the Hidden Moon.
