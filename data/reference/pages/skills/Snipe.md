...
Source: https://en.uesp.net/wiki/Online:Snipe
...
line=Bow
icon=Bow-Snipe
desc=Plant a masterfully aimed arrow in an enemy's vital spot, dealing [6365 / 6435 / 6505 / 6575] Physical Damage.
desc1=Plant a masterfully aimed arrow in an enemy's vital spot, dealing [6574 / 6646 / 6718 / 6790] Poison Damage and applying the Poisoned status effect. Also afflicts enemy with Minor Defile, which reduces their healing received and damage shield strength by 6% for 4 seconds.
desc2=Cost: [2700 / 2610 / 2520 / 2430] Stamina, Range: 40 meters. Plant a masterfully aimed arrow in an enemy's vital spot, dealing 6574 Physical Damage and applying the Sundered status effect.
linerank=2
cost=2700 Stamina
attrib=Stamina
...
morph1id=40897
morph1icon=Bow-Lethal Arrow
morph1desc=Deals Poison Damage and always applies the Poisoned status effect. Also applies Minor Defile to the enemy.
morph2name=Focused Aim
morph2id=40907
morph2icon=Bow-Focused Aim
morph2desc=Increases the range, always applies the Sundered status effect, and reduces cost as the ability ranks up.
image=ON-skill-Lethal Arrow.jpg
imgdesc=A Lethal Arrow

Snipe deals a large amount of Physical Damage to one target. In addition to being the highest damage ability in the Bow line, it is one of the longest ranged attacks of any Skill line. The Focused Aim increases the range, applies Sundered, and reduces the cost. Alternatively, the Lethal Arrow morph changes to Poison Damage and applies Poisoned and Minor Defile to the target.

## Notes
- The Piercing Spray set from Asylum Sanctorium can cause this ability to ignore some armor when combined with Arrow Spray.
- The Point-Blank Snipe weapon from Vateshran Hollows increases the damage done by this skill the closer you are to the target.

## Gallery

File:ON-skill-Focused_Aim.jpg| Snipe and Focus Aim's tracer
