...
Source: https://en.uesp.net/wiki/Online:Death_Stroke
...
line=Assassination
type=Ultimate
icon=Assassination-Death Stroke
desc=Ravage an enemy with a swift strike, dealing [9840 / 9948 / 10056 / 10164] Magic Damage and causing them to take 20% more damage from your attacks for 8 seconds.
desc1=Ravage an enemy with a swift strike, dealing [10164 / 10275 / 10387 / 10499] Disease Damage and causing them to take 20% more damage from your attacks for 8 seconds. If cast with 120 or more Ultimate, you instead deal [11180 / 11302 / 11425 / 11548] Disease Damage, stun the enemy for 3 seconds, and increase the duration of the damage taken effect to 12 seconds.
desc2=Ravage an enemy with a spinning attack, dealing 10164 Magic Damage and increasing your damage against them by 20% for 8 seconds. Also afflicts the enemy with Major Defile, reducing their healing received and damage shield strength by 12%. While slotted on either bar, any time you kill an enemy you gain [7 / 8 / 9 / 10] Ultimate.
linerank=12
cost=70 Ultimate
...
morph1id=37532
morph1icon=Assassination-Incapacitating Strike
morph1desc=Deals Disease Damage. Improves the ability significantly if cast with more Ultimate.
morph2name=Soul Harvest
morph2id=37545
morph2icon=Assassination-Soul Harvest
morph2desc=Also afflicts the enemy with Major Defile. While slotted on either bar, gain Ultimate whenever you kill an enemy.
image=ON-skill-Death Stroke under120.jpg
imgdesc=Death Stroke and its morphs' under 120 Ultimate cast visual

Death Stroke deals Magic Damage and increases damage against the affected enemy. The Incapacitating Strike morph changes the damage to Disease Damage and gets improved if cast with more than 120 Ultimate, which increases the damage and stuns the target. Or you could choose the Soul Harvest morph, which earns you extra Ultimate for each kill when it is slotted and inflicts Major Defile, reducing the target's Healing Received and damage shield strength.

## Notes
- Death Stroke is the cheapest of all the Ultimate abilities, especially when the Soul Harvest morph is chosen, because you earn some back for every kill.
- While under any effect that raises Ultimate costs, Incapacitating Strike will be unusable between 120 Ultimate and the adjusted cost of the improved version that stuns the target. For example, the stunning version costs 123 Ultimate for a stage 1 Vampire, and neither version of the skill will be usable between 120 and 122 Ultimate. The icon will still change color at 120.
...
- Before Update 41, Incapacitating Strike had a slotted effect called Reave which restored 100 Magicka and 100 Stamina every Light and Heavy Attack.
- Soul Harvest is a recommended morph for the Nightblade Initiate build, while Incapacitating Strike is recommended for Umbral Assassin.

## Gallery

File:ON-skill-Death Stroke over120.jpg|Death Stroke and its morphs' over 120 Ultimate cast visual
