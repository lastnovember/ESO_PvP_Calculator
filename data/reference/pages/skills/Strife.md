...
Source: https://en.uesp.net/wiki/Online:Strife
License: CC BY-SA, UESP

Online Skill Summary
id=35931
line=Siphoning
icon=Siphoning-Strife
desc=Steal an enemy's life force, dealing [4100 / 4145 / 4190 / 4235] Magic Damage and healing you or a nearby ally for 50% of the damage inflicted every 2 seconds for 10 seconds.
desc1=Steal an enemy's life force, dealing [4235 / 4281 / 4328 / 4374] Magic Damage and healing you or 3 other nearby allies for 50% of the damage inflicted every 2 seconds for 10 seconds.
desc2=Steal an enemy's life force, dealing [5717 / 5779 / 5842 / 5905] Magic Damage and healing you for 35% of the damage inflicted every 2 seconds for 10 seconds.
linerank=1
cost=2700 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=35941
morph1icon=Siphoning-Funnel Health
morph1desc=Heals two additional targets.
morph2name=Swallow Soul
morph2id=35949
morph2icon=Siphoning-Swallow Soul
morph2desc=Increases the damage done but reduces the healing caused. Heal only targets yourself.
image=ON-skill-Strife.jpg
imgdesc=Strife
area=15 meters

Strife deals Magic Damage to enemies and over time returns a proportion of that damage to you or an ally as Health. The Funnel Health morph also allows you to heal two additional allies, while the Swallow Soul morph increases the damage but reduces the healing effect and no longer heals allies.

## Notes
- Swallow Soul is a recommended morph for the Nightblade Initiate and Living Shadow builds, while Funnel Health is recommended for Blood Magus.
- Swallow Soul deals 35% more damage than Funnel Health. With the reduced proportion that it returns to you as healing, the net result is 94.5% (35% ÷ 50% × 135%) of the healing from Funnel Health.
...
ESO Patch Note|4.2.5|* Reduced the damage done by this ability by half, but it now also heals for 50% of the damage done and can now target you or any ally. The total healing amount remains unchanged.
- Swallow Soul: This morph now doubles the damage, but decreases the heal to 35% of the damage done and can only target you. The passive Minor Vitality effect has been removed.
