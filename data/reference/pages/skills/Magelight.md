...
Source: https://en.uesp.net/wiki/Online:Magelight
License: CC BY-SA, UESP

Online Skill Summary
id=42418
line=Mages Guild
icon=Mages Guild-Magelight
desc=Cost: [5400 / 5310 / 5220 / 5130] Magicka. Summon a mote of magelight, revealing stealthed and invisible enemies around you for 5 seconds. Exposed enemies cannot return to stealth or invisibility for 4 seconds. While slotted you gain Major Savagery and Prophecy, increasing your Weapon Critical and Spell Critical rating by 2629.
desc1=Summon a mote of magelight, revealing stealthed and invisible enemies around you for 5 seconds. Exposed enemies cannot return to stealth or invisibility for 4 seconds. While slotted you gain Major Savagery and Prophecy, increasing your Weapon Critical and Spell Critical rating by 2629 and your Max Magicka is increased by [2 / 3 / 4 / 5]%.
desc2=Cost: [5130 / 5040 / 4950 / 4860] Magicka, Radius: 12 meters. Summon a mote of magelight, revealing stealthed and invisible enemies around you for 5 seconds. Exposed enemies cannot return to stealth or invisibility for 4 seconds. While slotted you gain Major Savagery and Prophecy, increasing your Weapon Critical and Spell Critical rating by 2629. You also prevent the stun from stealth attacks for you and nearby allies.
linerank=2
cost=5130 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=42430
morph1icon=Mages Guild-Inner Light
morph1desc=Also increases your Max Magicka while slotted.
morph2name=Radiant Magelight
morph2id=42455
morph2icon=Mages Guild-Radiant Magelight
morph2desc=Increases the radius of the reveal. You and nearby allies cannot be stunned from sneak attacks while slotted. Reduces the cost as the ability ranks up.
image=ON-skill-Magelight.jpg
imgdesc=The effects of Magelight

Magelight creates a light which orbits around you, revealing all stealthed and invisible enemies around you. A target revealed this way cannot return to stealth or invisibility for 4 seconds. It also passively increases your Weapon Critical and Spell Critical while slotted. The Inner Light morph also increases your Maximum Magicka while slotted, while the Radiant Magelight morph reduces the cost and doubles the radius of the ability, while also passively preventing you and your allies from being stunned from sneak attacks.

## Notes
- This skill is most useful in PvP, as very few NPC enemies use stealth attacks.
- Before Update 10, this skill was a toggle that increased your Spell Critical while active, but also decreased your Maximum Magicka. Inner Light increased Maximum Magicka instead of decreasing it, and Radiant Magelight revealed hidden or invisible enemies, prevented being stunned by stealth attacks, and reduces damage from stealth attacks.
- Before Update 6, this skill was a toggle revealing hidden and invisible enemies to the caster, while increasing Spell Critical and decreasing Maximum Magicka while active. Inner Light further increased the spell critical, while Radiant Magelight decreased stealth attack damage for nearby allies.
