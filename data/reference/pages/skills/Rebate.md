...
Source: https://en.uesp.net/wiki/Online:Rebate
...
type=Passive
icon=Daedric Summoning-Rebate
desc=You restore 185 Magicka or Stamina when one of your non-Ultimate Daedric Summoning abilities end. The resource returned is dictated by the ability's cost.
desc2=You restore 371 Magicka or Stamina when one of your non-Ultimate Daedric Summoning abilities end. The resource returned is dictated by the ability's cost.
linerank1=8
linerank2=18

Rebate restores your Magicka or Stamina whenever one of your Daedric Summoning abilities ends with the resource restored based on the cost of the ability.

## Notes
- As of Update 9, the only way to unsummon a creature is to remove the skill from your skill bar. This can most easily be done via weapon swap, provided you don't have the same summoning skill in the same slot on both skill bars.
- You may also unsummon them from your character screen. Scroll down to the creature and click remove effect.
