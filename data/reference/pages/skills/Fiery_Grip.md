...
Source: https://en.uesp.net/wiki/Online:Fiery_Grip
License: CC BY-SA, UESP

Online Skill Summary
id=23744
line=Draconic Power
icon=Ardent Flame-Fiery Grip
desc=Lash out with a flaming chain, pulling an enemy to you. The searing metal deals [1499] Flame Damage, applies the Burning status effect, and taunts them for 15 seconds if they are not already taunted. This attack cannot be dodged or reflected. Also inflicts Minor Cowardice on the enemy, reducing ESO Weapon Damage Link | |y and Spell Damage for 430 for 10 seconds.
desc1=Lash out with a chain bound in jagged links, pulling yourself to an enemy. The searing metal deals 1499 Flame Damage and applies the Burning status effect. This attack cannot be dodged or reflected. Hitting the target grants you Major Berserk and Major Evasion for [10] seconds, increasing damage done by 10% reducing damage taken from area attacks by 20%.
desc2=Lash out with a chain bound in Draconic runes, pulling an enemy to you. The enchanted metal deals 1499 Flame Damage, applies the Burning status effect, and taunts them for 15 seconds if they are not already taunted. If the target cannot be pulled you restore the abilities Magicka cost. This attack cannot be dodged or reflected. Also inflicts Minor Cowardice on the enemy, reducing ESO Weapon Damage Link | |y and Spell Damage for 430 for [15] seconds.
linerank=42
cost=3780 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=32229
morph1icon=Ardent Flame-Chains of Devastation
morph1desc=Converts the enemy pull into a self pull that no longer taunts or debuffs. Grants Major Berserk and Major Evasion.
morph2name=Chains of Dominance
morph2id=23778
morph2icon=Ardent Flame-Unrelenting Grip
morph2desc=If the target cannot be pulled, you are refunded the Magicka cost. Extends the duration of Major Cowardice.
image=ON-skill-Fiery Grip.jpg
imgdesc=Fiery Grip

Fiery Grip deals fire damage and pulls the target of the attack towards you,taunts it, and also increases your Movement Speed for a few seconds. The Chains of Devastation morph will pull you to the enemy instead and grant you Major Berserk, increasing the damage of your attacks for 4 seconds. Or you can choose Unrelenting Grip, which will refund its casting cost if the enemy cannot be pulled. It still deals the Fire Damage if this occurs, at zero cost, so it can be a cheap (if not very powerful) fire attack on immovable enemies.
...
- Chains of Devastation was added in Update 37, replacing Empowering Chains, which provided Empower instead of Major Berserk.
...
- Empowering Chains: This ability now grants you Empower for 5 seconds.
ESO Patch Note|2.3.5|* Extended Chains' cost reduction and range increase effect is now a baseline effect for Fiery Grip.
...
- Empowering Chains morph: This morph will now always pull you to the target instead of pulling the target to you. It will continue to grant the Major Empower buff after being pulled as a morph effect.
- Extended Chains morph:
