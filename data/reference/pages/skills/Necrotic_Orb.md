...
Source: https://en.uesp.net/wiki/Online:Necrotic_Orb
License: CC BY-SA, UESP

Online Skill Summary
id=43406
line=Undaunted
icon=Undaunted-Necrotic Orb
desc=Project a globe of annihilation that slowly floats forward for 10 seconds, dealing [836 / 844 / 853 / 864] Magic Damage every 1 second to nearby enemies. An ally near the globe can activate the Combustion Synergy synergy, causing the orb to explode for 6147 Magic Damage to nearby enemies and restore 3960 Magicka or Stamina to the ally, whichever maximum is higher.
desc1=Project a globe of annihilation that slowly floats forward, dealing [864 / 873 / 884 / 894] Magic Damage every 1 second to nearby enemies. While the orb is active you gain [70 / 80 / 90 / 100] Health, Magicka, and ESO Stamina Link | Recovery. An ally near the globe can activate the Combustion Synergy synergy, causing the orb to explode for 6147 Magic Damage to nearby enemies and restore 3960 Magicka or Stamina to the ally, whichever maximum is higher.
desc2=Cost: 3780 Magicka. Project a globe of regeneration that slowly floats forward, healing for [1296 / 1311 / 1326 / 1340] Health every 1 second to you and nearby allies. An ally near the globe can activate the Healing Combustion Synergy synergy, causing the orb to explode and heal for 6149 Health to nearby allies and restoring 3960 Magicka or Stamina to the activator, whichever maximum is higher.
linerank=5
cost=2970 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=43415
morph1icon=Undaunted-Mystic Orb
morph1desc=Increases your Health, Magicka, and ESO Stamina Link | Recovery while active.
morph2name=Energy Orb
morph2id=43447
morph2icon=Undaunted-Energy Orb
morph2desc=The orb heals allies instead of damaging enemies and moves faster.
image=ON-skill-Necrotic Orb.jpg
imgdesc=A Necrotic Orb

Necrotic Orb creates an orb floating forward that causes Magic Damage to nearby enemies on its way. Your allies may activate the Combustion Synergy synergy, which causes the orb to explode and deal more damage to all nearby enemies, as well as restore that ally's Magicka or Stamina, based on which of their max values is higher. The Mystic Orb morph gives you Health, Magicka, and Stamina Recovery while the orb is active, while the Energy Orb morph, functions as a healing spell instead, restoring your allies' Health over time. The synergy also changes to Healing Combustion Synergy, which restores their Health in addition to Magicka or Stamina.
...
File:ON-skill-Mystic Orb.jpg|A Mystic Orb
...
ESO Patch Note|2.2.7|* Fixed several minor issues for the following abilities, based on the adjustments made in patch v2.2.5:
...
ESO Patch Note|2.3.5|* Fixed an issue with the synergies of this ability and its morphs not scaling with the synergy user's highest statistics.
...
ESO Patch Note|8.1.5|* Reduced the damage per tick by approximately15%.
