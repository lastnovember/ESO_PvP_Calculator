...
Source: https://en.uesp.net/wiki/Online:Helping_Hands
...
type=Passive
icon=
desc=WITH AN EARTHEN HEART ABILITY SLOTTED The strength of mountains fuels your mightiest blows. Dealing damage with a fully-charged Heavy Attack also applies Off Balance to the target.
desc2=WITH AN EARTHEN HEART ABILITY SLOTTED The strength of mountains fuels your mightiest blows. Dealing damage with a fully-charged Heavy Attack also applies Off Balance to the target and restores 1430 Stamina. The Stamina restore can occur once every 0.5 seconds.
linerank1=39
linerank2=50

Mountain Giant will make your Heavy Attacks set opponents Off Balance, and restore you Stamina if ranked up.

## Patch Notes
* This passive ability now restores Stamina based on your character level instead of your Max Stamina.
ESO Patch Note|5.3.4|* This passive no longer triggers off Stamina costing Earthen Heart abilities, namely being Stonefist and Stone Giant.
...
ESO Patch Note|8.3.5|* This passive now requires the ability cost of what triggered it to be greater than the restored amount of Stamina, to prevent situations where you could gain more Stamina than you had spent as Magicka.
