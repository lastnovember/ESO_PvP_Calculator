...
Source: https://en.uesp.net/wiki/Online:Volley
...
line=Bow
icon=Bow-Volley
desc=Launch a multitude of arrows into the sky to rain down, dealing [909 / 920 / 928 / 939] Physical Damage to enemies in the target area every 1 second for 8 seconds, after a 2 second delay.
desc1=Duration: [12 / 13 / 14 / 15] seconds. Launch a multitude of arrows into the sky to rain down, dealing 939 Physical Damage to enemies in the target area every 1 second for [10 / 11 / 12 / 13] seconds, after a 2 second delay.
desc2=Radius: 7 meters. Launch a multitude of arrows into the sky to rain down, dealing [1222 / 1234 / 1247 / 1260] Physical Damage to enemies in the target area every 1 second for 8 seconds, after a 2 second delay.
linerank=4
cost=2700 Stamina
attrib=Stamina
casttime=Instant
...
morph1id=40932
morph1icon=Bow-Endless Hail
morph1desc=Increases the duration.
morph2name=Arrow Barrage
morph2id=40944
morph2icon=Bow-Arrow Barrage
morph2desc=Increases the radius and damage done.
image=ON-skill-Volley.jpg
imgdesc=Volley

Volley deals physical damage over time in the target area. This is mostly effective against stationary opponents, or ones who have been stunned, rooted, knocked down, or otherwise immobilized. The Endless Hail morph increases the duration of the effect. Or you can benefit from the increased radius and damage from the Arrow Barrage morph.
...
File:ON-skill-Endless_Hail.jpg| Endless Hail
...
ESO Patch Note|2.4.5|* Fixed an issue where the visual effects from this ability and its morphs were not displaying when you cast it while silenced.
- Scorched Earth:
