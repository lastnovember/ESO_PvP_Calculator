...
Source: https://en.uesp.net/wiki/Online:Momentum
License: CC BY-SA, UESP

Online Skill Summary
id=39881
line=Two Handed
icon=Two Handed-Momentum
desc=Duration: [27 / 28 / 29 / 30] seconds. Focus your strength and resolve to gain Major Brutality and Sorcery, increasing your ESO Weapon Damage Link | |y and Spell Damage by 20%, as well as gaining Minor Endurance, increasing your ESO Stamina Link | Recovery by 15% for [27 / 28 / 29 / 30] seconds.
desc1=Cost: [3510 / 3420 / 3330 / 3240] Stamina, Duration: 60 seconds. Focus your strength and resolve to gain Major Brutality and Sorcery, increasing your ESO Weapon Damage Link | |y and Spell Damage by 20%, as well as gaining Minor Endurance, increasing your ESO Stamina Link | Recovery by 15% for 1 minute. Activating this ability removes all snares and immobilizations from you and grants immunity to them for 4 seconds.
desc2=Focus your strength and resolve to gain Major Brutality and Sorcery, increasing your ESO Weapon Damage Link | |y and Spell Damage by 20%, as well as gaining Minor Endurance, increasing your ESO Stamina Link | Recovery by 15% for 30 seconds. You heal for [4764 / 4816 / 4868 / 4921] Health when Rally ends. The final heal is increased by 20% every 2 seconds, up to a maximum of 200%.
linerank=38
cost=3780 Stamina
attrib=Stamina
casttime=Instant
...
morph1id=39892
morph1icon=Two Handed-Forward Momentum
morph1desc=Reduces the cost, increases the duration, and provides a brief immunity to snares and immobilizations.
morph2name=Rally
morph2id=39904
morph2icon=Two Handed-Rally
morph2desc=Also heals you when the effect expires.
image=ON-skill-Rally.jpg
imgdesc=Effect of using Momentum or Rally

Momentum increases your Weapon Damage and Spell Damage and Stamina Recovery. The Forward Momentum morph reduces the cost, increases the duration, cleanses and grants brief immunity to roots and snares effects, while Rally restores your Health when the effect ends with the heal scaling up based on how long Rally was active for.

## Gallery

File:ON-skill-Forward_Momentum.jpg|Forward Momentum's ground effect
...
ESO Patch Note|7.3.5|* This ability and its morphs now also grant Major Sorcery for their duration.
- Forward Momentum (morph):
- Increased the final cost of this ability to 3240, up from 2700.
- Increased the duration of Major and Minor buffs provided from this ability to 40 seconds, up from 20.
