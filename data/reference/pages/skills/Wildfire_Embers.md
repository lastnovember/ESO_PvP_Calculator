# Online:Wildfire Embers

Source: https://en.uesp.net/wiki/Online:Wildfire_Embers
...
line=Class Mastery
type=Passive
icon=Ardent Flame-Fan the Flames
desc=Fire forged within can never be extinguished. Fan the flames. When your Dragonknight damage over time effects end, you apply Wildfire Embers to the target, dealing 4277 Flame Damage over 12 seconds. This effect stacks up to 12 times and increases in damage by 25% per stack.
linerank1=1
