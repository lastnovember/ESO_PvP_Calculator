...
Source: https://en.uesp.net/wiki/Online:Fire_Rune
License: CC BY-SA, UESP

Online Skill Summary
id=42305
line=Mages Guild
icon=Mages Guild-Fire Rune
desc=Inscribe a rune of cosmic fire on the earth, which takes 2 seconds to arm and lasts for 20 seconds. When triggered, the rune blasts all enemies in the target area for [6147 / 6214 / 6281 / 6350] Flame Damage.
desc1=Cost: [3240 / 3150 / 3060 / 2970] Magicka. Inscribe a rune of cosmic fire on the earth, which takes 2 seconds to arm and lasts for 20 seconds. When triggered, the rune blasts all enemies in the target area for 6351 Flame Damage, knocks them into the air, and stuns them for 3 seconds.
desc2=Inscribe a rune of cosmic fire on the earth, which takes 2 seconds to arm and lasts for 20 seconds. When triggered, the rune blasts all enemies in the target area for 6351 Flame Damage and an additional [7590 / 7667 / 7744 / 7832] Flame Damage over 22 seconds.
linerank=6
cost=3240 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=42327
morph1icon=Mages Guild-Volcanic Rune
morph1desc=The rune knocks enemies into the air and stuns them. Reduces the cost as the ability ranks up.
morph2name=Scalding Rune
morph2id=42349
morph2icon=Mages Guild-Scalding Rune
morph2desc=The rune also deals additional damage over time.
image=ON-skill-Fire Rune.jpg
imgdesc=Fire Rune

Fire Rune creates a rune trap on the ground which deals Fire Damage to an enemy when they touch it. The Volcanic Rune morph will also knock up and stun most enemies, while the Scalding Rune morph adds a damage over time effect.

## Notes
- Only one Fire Rune may be active at a time. Casting a second one before the first has been triggered or expires will cause it to disappear.
- It is possible to affect multiple enemies at once with this spell if there are multiple enemies near each other when it arms. Casting the spell does not count as an attack, and will not cause enemies to attack you until after the trap has been triggered.

## Patch Notes
ESO Patch Note|1.3.4|* Scalding Rune: Fixed an issue where the damage-over-time from this ability would stack multiple times on the same enemy. We also fixed an issue where there were multiple copies of the FX playing after this ability was cast.
- Might of the Guild: Fixed an issue with this passive where, when combined with using the ability Scalding Rune repeatedly, you could place many Runes down at one time.
...
- Wall of Elements
- All elemental procs
- Fixed an issue where the explosion effects for this ability weren't playing when the ability triggered.
