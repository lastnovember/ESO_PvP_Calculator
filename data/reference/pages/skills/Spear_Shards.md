...
Source: https://en.uesp.net/wiki/Online:Spear_Shards
License: CC BY-SA, UESP

Online Skill Summary
id=27090
line=Aedric Spear
icon=Aedric Spear-Spear Shards
desc=Send your spear into the heavens to bring down a shower of divine wrath, dealing [4612 / 4662 / 4713 / 4764] Magic Damage to enemies in the area and an additional [437 / 443 / 446 / 451] Magic Damage every 1 second for 10 seconds. An ally near the spear can activate the Blessed Shards Synergy synergy, restoring 3960 Magicka or Stamina, whichever maximum is higher.
desc1=Cost: [2970 / 2880 / 2790 / 2700] Magicka. Send your spear into the heavens to bring down a shower of divine wrath, dealing 4764 Magic Damage to enemies in the area and an additional 453 Magic Damage every 1 second for 10 seconds. You or an ally near the spear can activate the Holy Shards Synergy Blessed Shards synergy, which restores 3960 Magicka and Stamina.
desc2=Send your spear into the heavens to bring down a shower of divine wrath, dealing 4764 Magic Damage to enemies in the area and an additional [732 / 740 / 748 / 756] Magic Damage every 1 second for 10 seconds. Enemies hit by the initial hit are immobilized for 4 seconds. An ally near the spear can activate the Blessed Shards Synergy synergy, restoring 3960 Magicka or Stamina, whichever maximum is higher.
linerank=30
cost=2970 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=27122
morph1icon=Aedric Spear-Luminous Shards
morph1desc=The synergy grants both Magicka and Stamina instead of whichever is lowest and you can use your own synergy. Reduces cost as the ability ranks up.
morph2name=Blazing Spear
morph2id=27167
morph2icon=Aedric Spear-Blazing Spear
morph2desc=Increases damage dealt of the residual effect. Initial hit immobilizes enemies.
image=ON-skill-Spear Shards.jpg
imgdesc=Spear Shards' Area of Effect

Spear Shards deal Magic Damage to the target area. Allies may activate the Blessed Shards Synergy Synergy to restore Magicka or Stamina, based on which of their max values is higher. The Luminous Shards morph also restores the other resource, while Blazing Spear deals an increased amount of damage.
...
ESO Patch Note|3.0.5|* The Synergy from this ability and its morphs now restore Stamina or Magicka, whichever pool is larger. The amount restored is now based on your character level instead of your Max Resource. The synergy also has a shared cooldown with the Necrotic Orb Synergy.
...
ESO Patch Note|4.2.5|* Increased the damage done by this ability and the Luminous Shards morph by approximately 67%.
...
ESO Patch Note|5.0.5|* Increased the initial hit damage of this ability and its morphs by approximately 36%.
...
ESO Patch Note|5.1.5|* Decreased cost of this ability and its morphs to 3024 from 3240.
...
ESO Patch Note|5.2.5|* This ability and its morphs now last 10 seconds, up from 8.
...
ESO Patch Note|10.0.5|* Blazing Spear: This morph now also causes the initial hit to immobilize enemies hit for 4 seconds.
...
ESO Patch Note|11.0.5|* Increased the damage of the residual damage over time effect from this ability and the Luminous Shards morph by ~23% to make up for the 1 second delay this ability has.
