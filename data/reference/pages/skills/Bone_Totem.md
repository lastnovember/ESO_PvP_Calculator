...
Source: https://en.uesp.net/wiki/Online:Bone_Totem
License: CC BY-SA, UESP

Online Skill Summary
id=40115093
line=Bone Tyrant
icon=Bone Tyrant-Bone Totem
desc=Cost: [4320 / 4230 / 4140 / 4050] Magicka. Summon an effigy of bone at your feet for 11 seconds that grants Minor Protection to you and your allies, reducing damage taken by 5%. Enemies in the area are afflicted with Major Cowardice, reducing their ESO Weapon Damage Link | |y and Spell Damage by 430. After 2 seconds, the totem begins fearing nearby enemies every 2 seconds, causing them to cower in place for 4 seconds.
desc1=Cost: [3510 / 3420 / 3330 / 3240] Magicka, Range: 28 meters, Target: Ground. Summon an effigy of bone for 11 seconds that grants Minor Protection to you and your allies, reducing damage taken by 5%. Enemies in the area are afflicted with Major Cowardice, reducing their ESO Weapon Damage Link | |y and Spell Damage by 430. After 2 seconds, the totem begins fearing nearby enemies every 2 seconds, causing them to cower in place for 4 seconds.
desc2=Duration: [11 / 11.7 / 12.3 / 13] seconds. Summon an effigy of bone at your feet for [11 / 11.7 / 12.3 / 13] seconds that grants Minor Protection to you and your allies, reducing damage taken by 5%. Enemies in the area are afflicted with Major Cowardice. After 2 seconds, the totem begins fearing nearby enemies every 2 seconds, causing them to cower in place for 4 seconds. Allies can activate the Pure Agony synergy, dealing 6186 Magic Damage over 5 seconds to enemies.
linerank=30
cost=4050 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=40118380
morph1icon=Bone Tyrant-Remote Totem
morph1desc=The totem can be summoned up to 28 meters away, and costs less.
morph2name=Agony Totem
morph2id=40118404
morph2icon=Bone Tyrant-Agony Totem
morph2desc=Allies can activate a synergy to damage to enemies. Increases the duration of the totem as the ability ranks up.
image=ON-skill-Bone Totem.jpg
imgdesc=Bone Totem and its morphs

Bone Totem places a totem on the ground that reduces the damage taken of you and your allies and causes nearby enemies to be afflicted with Fear, holding them in place and preventing them attacking for a short time. (Note that more powerful targets are immune to these effects.) and reduces enemies' Weapon Damage and Spell Damage. Remote Totem allows you to place the totem further away, while Agony Totem increases the duration and allows your allies to activate the Pure Agony Synergy Synergy, dealing Magic damage over time.

## Notes
- Agony Totem is a recommended morph for the Necromancer Initiate, Undying Warrior, and Flesh Sculptor builds.

## Patch Notes
[Patch 5.1.5] * Increased the duration of this ability and its morphs by 1 second to help improve its animation of the totem crumbling, along with adding a new function. These abilities will now pulse a fear once every 2 seconds after the initial 2 second delay, rather than only once.
[Patch 5.3.4] * Agony Totem: Fixed an issue where visual effects for the synergy of Pure Agony's cooldown indicator would appear to allies who were still on cooldown. The beam of necromantic light will now only show itself when you can activate the synergy.
...
ESO Patch Note|10.1.5|* This ability and its morphs now also apply Major Cowardice to enemies inside it. Such horrific sights instill hopelessness to even the mightiest of foes.
