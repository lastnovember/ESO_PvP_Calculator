# Online:Infectious Claws

Source: https://en.uesp.net/wiki/Online:Infectious_Claws
License: CC BY-SA, UESP

Rending Claws]] Online Skill Summary
id=58862
line=Werewolf
icon=Werewolf-Infectious Claws
desc= Shred enemies in front of you with your tainted claws, dealing [5765 / 5828 / 5891 / 5955] Disease Damage and an additional [9600 / 9700 / 9810 / 9910] Disease Damage over 20 seconds. Enemies hit by the initial hit are afflicted with the Diseased status effect.
desc1= Shred enemies in front of you with your tainted claws, dealing 5955 Disease Damage and an additional 9920 Disease Damage over 20 seconds. Afflicts enemies with Major Defile for [2 / 2.7 / 3.3 / 4] seconds, reducing their healing received and damage shield strength by 12%. Enemies hit by any part of the ability are afflicted with the Diseased status effect.
desc2= Shred enemies in front of you with your tainted claws, dealing [5955 / 6020 / 6086 / 6151] Disease Damage and an additional 9920 Disease Damage over 20 seconds. You are healed for [63 / 64 / 65 / 66]% of the damage over time caused. Enemies hit by the initial hit are afflicted with the Diseased status effect.
linerank=9
cost=3442 Stamina
attrib=Stamina
casttime=Instant
...
duration=20 seconds
target=Cone
morph1name=Claws of Anguish
morph1id=58876
morph1icon=Werewolf-Claws of Anguish
morph1desc=Afflicts enemies with Major Defile and each tick now also applies the Diseased status effect.
morph2name=Claws of Life
morph2id=58907
morph2icon=Werewolf-Claws of Life
morph2desc=The damage over time heals you for a portion of the damage caused.
image=ON-skill-Infectious Claws.jpg
imgdesc=Werewolf using Infectious Claws

Infectious Claws deals Disease Damage to all enemies in a conical area in front of you. The Claws of Anguish morph reduces the affected targets' healing received, while Claws of Life also restores your Health.
...
ESO Patch Note|5.2.5|* This ability and its morphs now immediately apply the Diseased status effect to enemies hit, and do Disease Damage rather than a hybrid of Physical and Disease Damage.
- Decreased the damage per tick of these abilities by approximately 40%.
- Claws of Life (morph):
- This morph now heals for 100% of the damage caused, instead of 50%. This will still result in an overall reduction, since the base damage has been reduced.
