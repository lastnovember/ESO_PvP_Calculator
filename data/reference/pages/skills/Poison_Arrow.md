...
Source: https://en.uesp.net/wiki/Online:Poison_Arrow
License: CC BY-SA, UESP

Online Skill Summary
id=40806
line=Bow
icon=Bow-Poison Arrow
desc=Shoot an arrow coated in Baandari poison at an enemy, dealing [3074 / 3107 / 3141 / 3175] Poison Damage and an additional [9210 / 9300 / 9410 / 9510] Poison Damage over 20 seconds.
desc1=Cost: [2700 / 2610 / 2520 / 2430] Stamina. Shoot an arrow coated in Shadowscale poison at an enemy, dealing 3175 Poison Damage and an additional 9520 Poison Damage over 20 seconds. If the enemy hit is casting an ability they are interrupted, set Off Balance, and stunned for 3 seconds. After casting you gain Major Brutality and Sorcery, increasing your ESO Weapon Damage Link | |y and Spell Damage for 20 seconds.
desc2=Shoot an arrow coated in Baandari poison at an enemy, dealing 3175 Poison Damage and an additional 9520 Poison Damage over 20 seconds. Deals up to [105 / 110 / 115 / 120]% more damage to enemies under 50% Health.
linerank=38
cost=2700 Stamina
attrib=Stamina
casttime=Instant
...
morph1id=40823
morph1icon=Bow-Venom Arrow
morph1desc=Interrupts enemies hit if they are casting. Grants Major Brutality and Sorcery after casting. Reduces cost as ability ranks up.
morph2name=Poison Injection
morph2id=40842
morph2icon=Bow-Poison Injection
morph2desc=Deals additional damage to low Health enemies.
image=ON-skill-Poison Arrow.jpg
imgdesc=Poison Arrow

Poison Arrow deals poison damage to a target, and additional poison damage over time. It can be a very effective attack on single targets, especially when combined with other abilities. The Venom Arrow morph interrupts, sets Off Balance and stuns casting enemies, while also granting Major Brutality and Major Sorcery which increases your Weapon Damage and Spell Damage. Alternatively, the Poison Injection morph makes it particularly effective as an execution spell, as it deals more damage the lower health your target is.

## Notes
- The poison damage over time does not stack, so there is no benefit to hitting the same target again while the previous poison is still in effect. Use other attacks instead while waiting for the first poison to expire. This does not apply if another Poison Arrow was cast by an other player.
...
- The Caustic Arrow set from Dragonstar Arena increases your Weapon Damage and Spell Damage against enemies affected by your Poison Arrow or its morphs.
...
- Venom Arrow: This ability now ranks up in cost reduction rather than 1.1% damage; the final base cost is 2430.
- Poison Injection: Reduced the total execute multiplier of this morph to 100% from 260%.
ESO Patch Note|5.2.5|* Decreased the damage per tick of this ability and its morphs by approximately 50%.
