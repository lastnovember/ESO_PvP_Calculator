# Online:Insatiable Hunger

Source: https://en.uesp.net/wiki/Online:Insatiable_Hunger
...
desc=WHILE YOU ARE IN WEREWOLF FORM Hunger gnaws at you. Like Storihbeg, shape it into a brutal weapon. Gain the ability to devour corpses, for up to 4 seconds per corpse. Each second devouring you heal for 3200 Health, based off your Max Health, and restore 15 Ultimate. If you are a Werewolf Berserker, each tick activates Fury generation.
linerank1=1

Insatiable Hunger allows you to devour nearby corpses, the time allowed increases with the number of bodies. Devouring a corpse will both heal based on your Max Health and generate Ultimate. If you are a Werewolf Berserker, the skill will also generate Fury.
