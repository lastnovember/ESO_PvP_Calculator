...
Source: https://en.uesp.net/wiki/Online:Fiery_Breath
License: CC BY-SA, UESP

Online Skill Summary
id=34031
line=Draconic Power
icon=Ardent Flame-Fiery Breath
desc=Exhale a blast of draconic fire in front of you, dealing [1874] Flame Damage and an additional [3215] Flame Damage over 10 seconds to enemies in your path.
desc1=Exhale a blast of draconic fire in front of you, dealing [1874] Flame Damage, applying the Burning status effect, and an additional [3215] Flame Damage over 10 seconds to enemies in your path. The initial hit liquifies the armor of your enemies applying Major Breach to enemies for the duration, reducing ESO Resistance Link|Physical | |y and Spell Resistance by 5948.
desc2=Cost: 3780 Magicka. Breathe forth and unending torrent of draconic fire in front of you, dealing [1114] Flame Damage every 0.5 seconds in a channeled attack over 4.8 seconds. Each tick increases the damage by 5%, up to a maximum of 50%. While Take Flight is active you always deal maximum damage. This ability is considered direct damage.
linerank=1
cost=2984 Stamina
attrib=Stamina
casttime=Instant
...
morph1id=34039
morph1icon=Ardent Flame-Noxious Breath
morph1desc=The initial hit applies the Burning status effect and Major Breach.
morph2name=Engulfing Dragonfire
morph2id=34048
morph2icon=Ardent Flame-Engulfing Flames
morph2desc=Converts the ability into a channeled attack that deals direct damage.
image=ON-skill-Fiery Breath.jpg
imgdesc=Fiery Breath

Fiery Breath deals Fire Damage to enemies within a 10 meter radius in front of you, and applies fire damage over time. Noxious Breath changes the cost to use Stamina and the damage from fire to poison, as well as reducing your targets' resistances. Or you can choose Engulfing Flames, which will increase the target's vulnerability to other flame attacks, either from you or other players.

## Notes
- The Damage Over Time effects applied by all three skills are considered as "Area DoT" for the purposes of status effects chance of apply.
- The Noxious Breath morph was added in Update 10, replacing 20 Burning Breath, which dealt Flame Damage instead of Poison Damage, and cost magicka.
...
File:ON-skill-Noxious_Breath.jpg|Noxious Breath
