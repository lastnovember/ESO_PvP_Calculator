# Online:Destructive Touch

Source: https://en.uesp.net/wiki/Online:Destructive_Touch
License: CC BY-SA, UESP

Online Skill Summary
id=40964
line=Destruction Staff
icon=Destruction Staff-Destructive Touch (Frost)
icon2=Destruction Staff-Destructive Touch (Shock)
icon3=Destruction Staff-Destructive Touch (Fire)
desc=Devastate an enemy with an enhanced charge from your staff, dealing [3074 / 3107 / 3141 / 3175] Magic Damage and an additional [9210 / 9300 / 9410 / 9510] Magic Damage over 20 seconds. The initial hit always applies the element's status effect.
desc1=Devastate an enemy with an enhanced charge from your staff, dealing 3175 Magic Damage. The initial hit always applies the element's status effect. Flame Clench also knocks the enemy back. Frost Clench deals less damage, has increased range, applies Major Maim, immobilizes, and taunts the enemy. Shock Clench converts the attack into an area of effect explosion.
desc2=Cost: [2970 / 2880 / 2790 / 2700] Magicka, Range: 28 meters. Devastate an enemy with an enhanced charge from your staff, dealing 3175 Magic Damage and an additional 9520 Magic Damage over 20 seconds. The initial hit always applies the element's status effect.
linerank=14
cost=2970 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=41006
morph1icon=Destruction Staff-Destructive Clench
morph1desc=Converts the damage over time into a new effect based on your staff type.
morph2name=Destructive Reach
morph2id=41047
morph2icon=Destruction Staff-Destructive Reach
morph2desc=Increases the range. Reduces the cost as the ability ranks up.
image=ON-skill-Shock Touch.jpg
imgdesc=Shock Touch and Shock Reach

Destructive Touch deals magic damage and additional damage over time.

The Destructive Clench morph removes the damage over time but adds additional effects based on the staff type:
- 18 Flame Clench knocks the target back.
- 18 Frost Clench reduces the damage but increases the range and immobilizes, taunts and applies Major Maim of the target.
- 18 Shock Clench deals splash damage to other nearby enemies.
...
## Notes
- Shock Clench's guaranteed Concussion apply on initial hit works only for the initial target, not the whole AoE.
- The Destructive Impact set from Dragonstar Arena will reduce the Magicka cost of Destructive Touch and its morphs by 10% and will increase your Weapon Damage and Spell Damage after casting for a short time.
- Destructive Clench is a recommended morph for the Deathweaver build.

## Gallery

File:ON-skill-Flame Touch.jpg|Flame Touch and Flame Reach
File:ON-skill-Frost Touch.jpg|Frost Touch and Frost Reach
File:ON-skill-Flame Clench.jpg|Flame Clench
File:ON-skill-Frost Clench.jpg|Frost Clench
...
- Shock Touch, the lightning staff variant of Destructive Touch, now deals damage to nearby targets instead of disorienting the target.
...
ESO Patch Note|2.1.4|* Frost Touch and its morphs will no longer apply a half-second stun to the target.
