...
Source: https://en.uesp.net/wiki/Online:Mend_Wounds
License: CC BY-SA, UESP

Online Skill Summary
id=40103543
line=Psijic Order
icon=Psijic Order-Mend Wounds
desc=Invoke the Rites of Moawita, replacing your Light and Heavy Attacks with healing abilities that can only be used on allies. Your Light Attacks heal for [2490 / 2517 / 2544 / 2572]. Your Heavy Attacks heal for [2214 / 2238 / 2262 / 2287] every 1 second, and restore 1155 Magicka to you for successfully healing.
desc1=Invoke the Rites of Moawita, replacing your Light and Heavy Attacks with healing abilities that only can be used on allies. Your Light Attacks heal for [2572 / 2600 / 2628 / 2656]. Your Heavy Attacks heal for [2286 / 2311 / 2336 / 2361] every 1 second, and restore 1155 Magicka to you for successfully healing. After you heal an ally you grant them Major Resolve, increasing their ESO Resistance Link|Physical | |y and Spell Resistance by 5948 for 5 seconds.
desc2=Invoke the Rites of Moawita, replacing your Light and Heavy Attacks with healing abilities that can be used on allies. Your Light Attacks heal for [2572 / 2600 / 2628 / 2656]. Your Heavy Attacks heal for [2286 / 2311 / 2336 / 2361] every 1 second, and restore 1155 Magicka to you for successfully healing. You heal yourself for 50% of the amount of healing done to the ally.
linerank=6
cost=Free
attrib=Magicka
casttime=Instant
...
morph1id=40103747
morph1icon=Psijic Order-Mend Spirit
morph1desc=Increases your ally's ESO Resistance Link|Physical | |y and Spell Resistance while you heal them.
morph2name=Symbiosis
morph2id=40103755
morph2icon=Psijic Order-Symbiosis
morph2desc=You heal yourself for a percentage of the healing done to the ally.
image=ON-skill-Mend_Wounds.jpg
imgdesc=Mend Wounds

Mend Wounds this is a toggle ability that replaces your Light and Heavy attacks with healing spells that can be used on an ally. After casting, your Light Attack will heal for a small amount, or by a larger amount for as long as you channel a Heavy Attack that also returns magicka. The Mend Spirit morph will also increase your target's resistances while healing, while Symbiosis heals you as well by half of the amount of your ally. Note that this spell is mostly useless for solo play, even with Symbiosis, as you do need a friendly target in order to trigger the healing, so casting it without an ally nearby will simply make your regular attacks ineffective while active. Sorcerers and Wardens with pets may still get some benefit from this in solo play, but It can be also used on companions to grant a healing benefit in solo play as well albeit it's preferred with other players

## Gallery

File:ON-skill-Mend_Wounds_HA.jpg|Heavy attacking
