# Online:Lightning Form

Source: https://en.uesp.net/wiki/Online:Lightning_Form
License: CC BY-SA, UESP

Online Skill Summary
id=30235
line=Storm Calling
icon=Storm Calling-Lightning Form
desc=Manifest yourself as pure lightning, zapping nearby enemies with electricity dealing [1230 / 1243 / 1257 / 1270] Shock Damage every 2 seconds for 20 seconds. While in this form you also gain Major Resolve, increasing your Physical Resistance and Spell Resistance by 5948.
desc1=Cost: 2295 Stamina. Manifest yourself as pure air, buffeting nearby enemies with wind dealing [1269 / 1282 / 1296 / 1310] Physical Damage every 2 seconds for 20 seconds. The winds grow in damage and size, increasing up to 120% more damage and up to 9 meters in size. While in this form you gain Major Resolve and Minor Expedition, increasing your ESO Resistance Link|Physical | |y and Spell Resistance by 5948 and your Movement Speed by 15%.
desc2=Duration: [27 / 28 / 29 / 30] seconds. Manifest yourself as pure lightning, zapping nearby enemies with electricity dealing 1269 Shock Damage every 2 seconds for [27 / 28 / 29 / 30] seconds. While in this form you also gain Major Resolve, increasing your Physical Resistance and Spell Resistance by 5948. Activating this grants you Major Expedition, increasing your Movement Speed by 30% for 4 seconds.
linerank=4
cost=2700 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=30244
morph1icon=Storm Calling-Hurricane
morph1desc=Converts into a Stamina ability and deals Physical Damage. Increases in size and damage the longer it is active. Grants Minor Expedition while active, increasing your Movement Speed.
morph2name=Boundless Storm
morph2id=30255
morph2icon=Storm Calling-Boundless Storm
morph2desc=Increases the duration, and you gain Major Expedition for brief period after activation, increasing your Movement Speed.
image=ON-skill-Lightning Form cast.jpg
imgdesc=Lightning Form and Boundless Storm morph cast visual

Lightning Form causes the caster to transform into physical lightning, protecting you from damage and causing Shock Damage to any enemies that come near. Hurricane changes the casting cost to use Stamina and the damage to be Physical Damage, while slightly increasing your movement speed. Also the damage and area size increases over time. Boundless Storm increases your movement speed by a greater degree, but for a shorter time, while the primary effects will last for longer.

## Notes
- When using either morph for its increased movement speed (and not for offensive purposes), be careful around neutral enemies, as being hit by this ability will cause them to become hostile. If you were wearing a disguise, it will blow your cover as well.
- The Hurricane morph was added in Update 10, replacing Thundering Presence, which dealt additional Shock Damage for the first few seconds while also granting Major Expedition.
- Boundless Storm is a recommended morph for the Sorcerer Initiate, Elemental Arcanist and War Mage builds, while Hurricane is recommended for Arcane Warrior.

## Gallery

File:ON-skill-Lightning Form attack.jpg|Lightning Form's and Boundless Storm morph's attack visual
File:ON-skill-Lightning Form zone.jpg|Lightning Form's and Boundless Storm morph's zone visual
File:ON-skill-Hurricane cast.jpg|Hurricane morph's cast visual
File:ON-skill-Hurricane zone 1.jpg|Hurricane morph's first zone visual
File:ON-skill-Hurricane zone 2.jpg|Hurricane morph's second zone visual
...
ESO Patch Note|2.6.4|* Boundless Storm: Fixed an issue where this morph's visual effects were not all displaying properly when hit by the Serpent Fang monster's Poison Arrow Spray ability.
- Hurricane: Fixed an issue where this morph did not gain any benefits as it increased in rank. It now deals slightly more damage as it ranks up.
...
- This morph no longer ranks up in 1.1% damage done per rank.
- Hurricane (morph):
