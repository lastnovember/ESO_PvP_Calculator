...
Source: https://en.uesp.net/wiki/Online:Inhale
License: CC BY-SA, UESP

Online Skill Summary
id=33697
line=Ardent Flame
icon=Draconic Power-Inhale
desc=Let the fire within draw heat into your core, restoring 15% of your missing Magicka and Stamina every 2 seconds over 4 seconds. When this ability completes, you release this heat as a blast of fire that deals 2154 Flame Damage to nearby enemies.
desc1=Let the fire within draw heat into your soul, restoring 15% of your missing Magicka and Stamina every 2 seconds over 4 seconds. Much of this heat is drawn from enemies around you. Those that are casting are interrupted, set Off Balance, and stunned for 2 seconds. When this ability completes, you release this heat as a blast of fire that deals 2969 Flame Damage to nearby enemies.
desc2=Let the fire within draw heat into your heart, restoring 12% of your missing Health and 15% of your missing Magicka and Stamina every 2 seconds over 4 seconds. When this ability completes, you release this heat as a blast of fire that deals 2969 Flame Damage to nearby enemies.
linerank=42
cost=3510 Magicka
attrib=Magicka
casttime=Instant
...
morph1id=33715
morph1icon=Draconic Power-Deep Breath
morph1desc=Initial hit interrupts enemies that are casting. Final explosion damage increased.
morph2name=Heart of Flame
morph2id=33732
morph2icon=Draconic Power-Draw Essence
morph2desc=Adds a heal based on your mission Health.
image=ON-skill-Inhale.jpg
imgdesc=Core of Flame...

Inhale drains Health from nearby enemies around you and then deals Fire Damage to all nearby enemies a few seconds later. The Deep Breath morph causes this skill to interrupt any enemies that are casting a spell, stunning them and setting them off balance, while Draw Essence morph restores your Magicka by 10% of its cost for each enemy hit, which can allow you to cast it repeatedly in a large mob.

## Notes
- The fire explosion will not trigger if you cast Inhale again before it would.
- Draw Essence is a recommended morph for the Dragonknight Initiate build.
...
ESO Patch Note|6.1.5|* Deep Breath (morph): This morph's explosion now deals 25% more damage. The initial hit no longer ranks up by 1.1% damage per rank, but the final hit now does.
