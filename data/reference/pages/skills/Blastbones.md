...
Source: https://en.uesp.net/wiki/Online:Blastbones
...
id=40114860
line=Grave Lord
icon=Grave Lord-Blastbones
desc= Summon a flaming skeleton from the ground after 2.5 seconds. The skeleton runs after the target and explodes when it gets close to them, dealing [9223 / 9324 / 9426 / 9527] Flame Damage to all enemies nearby. Creates a corpse on death.
desc1=Cost: 2295 Stamina. Summon a decaying skeleton from the ground after 2.5 seconds. The skeleton runs after the target and explodes when it gets close to them, dealing [9529 / 9633 / 9737 / 9842] Disease Damage to all enemies nearby and applying Major Defile to them for 4 seconds, reducing their healing received and ESO Health Link | Recovery by 16%. Creates a corpse on death.
desc2= Summon a flaming skeleton from the ground after 2.5 seconds. The skeleton runs after the target and explodes when it gets close to them, dealing [9529 / 9633 / 9737 / 9842] Flame Damage to all enemies nearby. Every second the skeleton spends chasing its target increases the damage of the explosion by 10%, up to a maximum of 50% more damage. Creates a corpse on death.
linerank=4
cost=2700 Magicka
attrib=Magicka
casttime=Instant
...
morph1desc=Converts into a Stamina ability and deals Disease Damage. Reduces healing received on enemies hit.
morph2name=Stalking Blastbones
morph2id=40117749
morph2icon=Grave Lord-Stalking Blastbones
morph2desc=The skeleton deals more damage the longer it chases the target.
image=ON-skill-Blastbones.jpg
imgdesc=Blastbones

Blastbones creates a skeleton from the ground which runs toward the selected target and explodes, dealing Flame Damage to all nearby enemies. Casting this in the presence of justice neutral NPCs will earn you a bounty. The Blighted Blastbones morph changes the casting cost to Stamina and the damage to Disease Damage, also reducing the target's healing received, while the Stalking Blastbones morph deals more damage the longer it chases a target.

## Notes
- Blastbones is one of the fastest ways to create a free corpse, which can be used for a number of other Necromancer abilities.
- Blighted Blastbones is a recommended morph for the Deathbringer build, while Stalking Blastbones is recommended for Necromancer Initiate and Baleful Summoner.
- Blastbones is depicted as a card in Legends.
- The Stalking Blastbones morph is only effective if the target is moving and either turns a corner or gets far enough away to make the skeleton run before it can leap. Stationary targets, even at max range, will not trigger the stalking effect.

## Gallery

File:ON-skill-Blighted Blastbones.jpg|Blighted Blastbones
File:ON-skill-Stalking Blastbones.jpg|Stalking Blastbones
...
ESO Patch Note|9.3.5|* Renamed this ability to Sacrificial Bones.
