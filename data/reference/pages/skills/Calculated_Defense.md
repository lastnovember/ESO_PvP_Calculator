# Online:Calculated Defense

Source: https://en.uesp.net/wiki/Online:Calculated_Defense
...
line=Class Mastery
type=Passive
icon=Class Mastery-Calculated Defense
desc=Success is a certainty when nothing is left to chance. While beginning to use a Sorcerer ability or an ability with a cast time, you gain a damage shield for 0.5 seconds that can absorb 5280 damage. This effect is based off your Max Health. If the shield does not break, you and nearby group members gain 6% ESO Weapon Damage Link | |y and Spell Damage for 20 seconds.
linerank1=1
