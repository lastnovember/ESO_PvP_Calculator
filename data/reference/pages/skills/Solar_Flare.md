...
Source: https://en.uesp.net/wiki/Online:Solar_Flare
License: CC BY-SA, UESP

Online Skill Summary
id=24110
line=Dawn's Wrath
icon=Dawn's Wrath-Solar Flare
desc=Conjure a ball of solar energy to heave at an enemy, dealing [6365 / 6435 / 6505 / 6575] Magic Damage and increasing your damage done with class abilities by 5% for 10 seconds. Also grants you Empower for 10 seconds, increasing the damage of your Heavy Attacks against monsters by 150%.
desc1=Cost: 2430 Magicka. Conjure a ball of solar energy to heave at an enemy, dealing [6574 / 6646 / 6718 / 6790] Magic Damage and increasing your damage done with class abilities by 5% for 10 seconds. Afflicts the target and enemies within 8 meters with Major Defile, reducing their healing received and damage shield strength by 12% for 4 seconds. Also grants you Empower for 10 seconds, increasing the damage of your Heavy Attacks against monsters by 150%.
desc2=Casting Time: Instant, Duration: 20 seconds, Area: 8 meters, Target: Area. Conjure solar energy to blast enemies around you, dealing [1154 / 1166 / 1179 / 1192] Magic Damage every 2 seconds and increasing your damage done with class abilities by 5% for 20 seconds. While this ability is active you gain Empower, increasing the damage of your Heavy Attacks against monsters by 150%.
linerank=4
cost=2700 Magicka
attrib=Magicka
...
morph1id=24147
morph1icon=Dawn's Wrath-Dark Flare
morph1desc=Reduces cost and applies Major Defile to the target and nearby enemies.
morph2name=Solar Barrage
morph2id=24157
morph2icon=Dawn's Wrath-Solar Barrage
morph2desc=Deals damage in multiple blasts as damage over time around you instead of at a single enemy.
image=ON-skill-Solar_Flare.jpg
imgdesc=Solar Flare

Solar Flare deals Magic Damage to an enemy, increases the damage of your other class abilities and increases your damage dealt with Heavy Attacks. The Dark Flare morph reduces both your target's as well as other nearby targets' ability to heal and shield strength (though only your primary target actually takes damage). Or you can choose the Solar Barrage morph which changes this to an instant-cast, pulsing Area Effect damage over time that's centered on you.

## Gallery

File:ON-skill-Dark_Flare.jpg|Dark Flare in use
File:ON-skill-Solar_Barrage.jpg|Solar Barrage in use
...
ESO Patch Note|5.0.5|* Reduced the cast time from this ability and the Dark Flare morph to 1 second from 1.1 seconds.
...
ESO Patch Note|5.1.5|* Increased the damage of this ability and the Dark Flare morph by approximately 4%.
- Solar Barrage: Decreased the damage of this morph by approximately 33% per tick.
ESO Patch Note|5.2.5|* Solar Barrage:
- Increased the duration of this morph to 8 seconds, up from 6.
- Decreased the damage per tick by approximately 15%.
ESO Patch Note|6.3.5|*Reduced the cast time of this ability and the Dark Flare morph to 0.8 seconds, down from 1 second.
