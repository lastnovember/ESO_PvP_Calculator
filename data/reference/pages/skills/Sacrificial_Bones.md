...
morph1id=40117690
morph1icon=Grave Lord-Blighted Blastbones
morph1desc=Converts into a Stamina ability that deals Disease Damage to enemies instead of empowering you. Applies Major Defile and the Diseased status effect to enemies hit.
morph2name=Grave Lord's Sacrifice
morph2id=40117749
morph2icon=Grave Lord-Grave Lord's Sacrifice
morph2desc=Increases the duration. While active, your third Flame Skull deals damage in an area.
image=ON-skill-Sacrificial Bones cast.jpg
imgdesc=Sacrificial Bones and its morphs' cast visual

Sacrificial Bones summons a skeleton that leaps on you which increases your damage done with class abilities and damage over time for a brief period. Grave Lord's Sacrifice morph further upgrades the skill to last longer and makes every third Flame Skull cast to do area of effect damage. Blighted Blastbones morph radically changes to skill to cost stamina and makes the summoned skeleton chase an enemy and explodes at them, dealing area of effect Disease damage and Applying the Diseased status effect and Major Defile to all enemies hit, reducing their Healing Received and Shield Strength by 12%.

## Notes
- Blighted Blastbones is one of the fastest ways to create a free corpse, which can be used for a number of other Necromancer abilities. The Blighted Blastbones is also an NPC which can be damaged by enemies and killed before it explodes.
- Prior to Update 41, this skill was called Blastbones. Blastbones was similar to Blighted Blastbones but did Fire Damage.
- According to patch notes for Update 46 Flame Skull's base effect now includes creating a corpse and the effect has been removed from Grave Lord's Sacrifice.

## Gallery

File:ON-skill-Blighted Blastbones.jpg|Blighted Blastbones
File:ON-skill-Sacrificial Bones jump.jpg|Skeleton jumping towards the caster

## Patch Notes
ESO Patch Note|5.1.5|* Removed the delay of the skeleton summoned from this ability and its morphs before it would attempt to leap to its target, to help reliability.
