...
Source: https://en.uesp.net/wiki/Online:Skills
...
Winter's Embrace Green Balance Animal Companions
Grave Lord Bone Tyrant Living Death
Herald of the Tome Soldier of Apocrypha Curative Runeforms

Additionally, Class Mastery is available if not subclassing.
...
## Racial
Each race has its own skill line which becomes available at level 5. Your overall character level determines the abilities you may choose from your racial skills. See:
...
- Assault
- Support
- Emperor - a set of passive abilities possessed only by current Emperors
...
There are several methods of earning skill points, listed below, up to a current total of 579 points including all Chapters and other DLCs:
...
- Completing the Western Solstice storyline (3 Skill Points)
- Completing the Eastern Solstice storyline (6 Skill Points)
...
- Completing the primary quest chain of the DragonholdDragonhold storyline (6 Skill Points)
- Completing the primary quest chain of the MarkarthMarkarth storyline (6 Skill Points)
- Completing the primary quest chain of the The DeadlandsThe Deadlands storyline (6 Skill Points)
- Completing the primary quest chain of the GalenFiresong storyline (6 Skill Points)
- Completing the epilogue of the Season of the DragonDragonhold storyline (3 Skill Points)
- Completing the epilogue of the Dark Heart of SkyrimMarkarth storyline (3 Skill Points)
- Completing the epilogue of the Gates of OblivionThe Deadlands storyline (3 Skill Points)
- Completing the epilogue of the Legacy of the BretonsFiresong storyline (3 Skill Points)
- Completing the epilogue of the Secrets of Apocrypha storyline (3 Skill Points)
- Absorbing skyshards (113 Skill Points in the base game: 80 more including all DLCs (up to Galen) and all Chapters, and Season Zones)
- Ranking up in the Alliance War (50 Skill Points)
- Completing group challenges in public dungeons (18 Skill Points in the base game, 18 more in expansions and Chapters - 2 each in OrsiniumOrsinium, Vvardenfell, Summerset, Elsweyr Greymoor, Blackwood, High Isle, Necrom, West Weald and Solstice)
- Completing the public dungeon quests in High Isle (2 Skill Points)
- Completing the story quest in group dungeons (24 Skill Points in the base game, one for each completed dungeon storyline quest: plus 30 more including those added by Imperial CityImperial City, Shadows of the HistShadows of the Hist, Horns of the ReachHorns of the Reach, Dragon BonesDragon Bones, WolfhunterWolfhunter, WrathstoneWrathstone, ScalebreakerScalebreaker, HarrowstormHarrowstorm, StonethornStonethorn Flames of AmbitionFlames of Ambition, Waking FlameWaking Flame, Ascending TideAscending Tide, Lost DepthsLost Depths, Scribes of FateScribes of Fate, Scions of ItheliaScions of Ithelia, Fallen BannersFallen Banners and Feast of ShadowsFallen Banners)
- Completing OrsiniumOrsinium Maelstrom Arena (1 Skill Point)
- Completing all Scribing quests (1 Skill point)
...
### Unobtainable Skill Points
- Two of the skill points listed above are unobtainable if you decide not to accept the Folium Discognitum in the Mages Guild questline.
- One additional Skill Point (not listed above) was granted to any character who completed a Chapter-specific tutorial quest between the release of Morrowind (Update 14) and the release of Update 44, after which Soul Shriven in Coldharbour was restored as the tutorial quest for all new characters.
