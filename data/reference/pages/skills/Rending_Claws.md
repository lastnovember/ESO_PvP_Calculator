# Online:Rending Claws

Source: https://en.uesp.net/wiki/Online:Rending_Claws
License: CC BY-SA, UESP

Online Skill Summary
id=58862
line=Werewolf
icon=Werewolf-Rending Claws
desc= Shred up to 6 enemies in front of you with wild abandon, dealing [5287 / 5345 / 5403 / 5461] Physical Damage and an additional [10550 / 10665 / 10785 / 10900] Bleed Damage over 10 seconds. Reduced to [6330 / 6399 / 6471 / 6540] Bleed Damage over 6 seconds against players. The initial hit has a 15% chance of applying Sundered, while the damage over time has a 5% chance of applying Hemorrhaging.
desc1=Casting Time:, Channel Time: 4.7 seconds, Cost: 383 Stamina / 1s, Target: Area. Shred up to 6 enemies in front of you with furious intent, dealing [58162 / 58799 / 59436 / 60073] Physical Damage in a channeled attack over 4.7 seconds. Dealing damage with this ability generates 15 Fury and a stack of Blood Hunger, up to once per second. This ability deals 25% more damage per stack of Blood Hunger, consumes all stacks when the ability ends, and is considered direct damage.
desc2= Shred up to 6 enemies in front of you with blood soaked claws, dealing [5461 / 5521 / 5581 / 5641] Physical Damage and an additional 10920 Bleed Damage over 10 seconds. Reduced to 6552 Bleed Damage over 6 seconds against players. You heal for 40% of the initial hit's damage, while you heal for [990 / 1000 / 1011 / 1022] Health with the damage over time, based off your Max Health. The initial hit grants a stack of Blood Hunger per enemy hit and has a 15% chance of applying Sundered, while the damage over time has a 5% chance of applying Hemorrhaging.
linerank=9
cost=995 Stamina
casttime=Instant
duration=10 seconds
...
morph1id=58876
morph1icon=Werewolf-Claw Fury
morph1desc=Converts into a direct damage channeled attack. Generates Fury and Blood Hunger and increases in damage based on Blood Hunger stacks.
morph2name=Bloodclaws
morph2id=58907
morph2icon=Werewolf-Claws of Life
morph2desc=The initial hit heals for a portion of the damage caused, while the damage over time heals based off your Max Health.
area=7 meters

Rending Claws deals physical damage and additional bleed damage for 10 seconds. The first hit will also have the chance of applying Sundered to the target, while the damage over time effect will also have a chance of applying Hemorrhaging.

The Claw Fury morph converts the ability into a direct damage channeled attack. Dealing damage with this morph will also generate Fury and Blood Hunger. Stacks of Blood Hunger will increase the amount of direct damage caused.

The Bloodclaws morph will heal you for 40% of the intial hit's damage, while the damage over time effect will also heal you based on your Max Health. The intial hit will also provide a stack of Blood Hunger per an enemy hit, as well as a chance to apply the aforementioned Sundered and Hemorrhaging status effects to the target.

## Patch Notes
ESO Patch Note|12.0.5|*Infectious Claws -> Rending Claws: This ability and the Claws of Life morph have been adjusted to deal Physical Damage on their initial hit and Bleed Damage for their over time effect, rather than dealing Disease Damage on both hits. Reduced the initial hit’s Weapon and Spell Damage scaling by 20%, and increased its Magicka and Stamina scaling by 4%. The damage over time now lasts for 10 seconds, down from 20. Increase the Weapon and Spell Damage scaling by ~92% and the Magicka and Stamina scaling by ~150%. This ability and its morphs now have a target cap of 6, rather than hitting all enemies. The initial hit now has a 15% chance of applying Sundered and the damage over time has a 5% chance of applying Hemorrhaging, rather than the initial hit applying Diseased and the damage over time having a 1%.
...
[Patch 12.0.6] *The Werewolf's Claw Fury damage impacts no longer cause silent audio. Sounds should now play as expected.
