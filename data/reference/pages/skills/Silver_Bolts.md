...
Source: https://en.uesp.net/wiki/Online:Silver_Bolts
License: CC BY-SA, UESP

Online Skill Summary
id=42655
line=Fighters Guild
icon=Fighters Guild-Silver Bolts
desc=Fire a Dawnguard Vampire Hunter's crossbow bolt to strike an enemy, dealing [5535 / 5595 / 5656 / 5717] Physical Damage.
desc1=Area: 5 meters. Fire an augmented Dawnguard Vampire Hunter's crossbow bolt to strike an enemy, dealing 5717 Physical Damage. Fires additional bolts at other enemies near the initial target for [25 / 24 / 23 / 22]% less damage.
desc2=Cost: 3780 Stamina, Range: 22 meters. Fire a Dawnguard's crossbow hook to pull an enemy to you, dealing [3811 / 3852 / 3894 / 3936] Physical Damage, taunting them for 15 seconds if they are not already taunted, and reducing their Movement Speed by 30% for 4 seconds.
linerank=2
cost=2700 Stamina
attrib=Stamina
casttime=Instant
...
morph1id=42671
morph1icon=Fighters Guild-Silver Shards
morph1desc=Fires additional bolts at other enemies near the initial target for less damage.
morph2name=Silver Leash
morph2id=42696
morph2icon=Fighters Guild-Silver Leash
morph2desc=Decrease the range and damage, increases the cost, but pulls the enemy to you, attempts to taunt them, and snares them.
image=ON-skill-Silver Bolts.jpg
imgdesc=Firing Silver Bolts

Silver Bolts deals Physical Damage to a single opponent, or up to six opponents with the Silver Shards morph. Choosing the Silver Leash morph increases the cost and reduces the range and damage but pulls the target to you while reducing their movement speed and attempting to taunt them.

## Notes
- In some cases, when using Silver Leash, the target will be unable to move. This can happen in various situations:
...
- Using Silver Leash around other players can cause confusion or even annoyance. As a matter of etiquette, it's probably best to avoid using it on a target who is already engaged with another player, unless they appear to be in need of a rescue.
- The skill was known as 'Crossbow Pistol' at an early point in development, with the description "Fire a pistol shot that stuns undead and daedra. Target evaporates into ash."

## Gallery

File:ON-skill-Silver_Bolts_02.jpg|Silver Bolts in use
File:ON-skill-Silver_Shards.jpg|Silver Shards striking multiple targets
File:ON-skill-Silver_Leash.jpg|Silver Leash pulling a target
...
- Silver Leash: Activating the secondary effect that pulls the target to you no longer has a cost, and now deals 15% more damage. This ability also now scales off Stamina instead of Magicka.
ESO Patch Note|2.1.4|* Fixed an issue where arrows would be missing after repeatedly using this ability.
- Silver Leash:
