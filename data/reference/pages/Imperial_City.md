# Online:Imperial City

Source: https://en.uesp.net/wiki/Online:Imperial_City
Fetched: 2026-09-12
License: CC BY-SA, UESP

Imperial City (DLC) Online Place Summary
type=Zone
description=the central city and capital of Cyrodiil and the former Empire.
image=ON-place-Imperial City.jpg
imgdesc=The Imperial City
addabove=The
mapworld=ava_whole
mapname=Imperial City
level=
discoverable=
completion=
quests=8
...
skyshard=13
alliance=Disputed
location=The center of Cyrodiil
marker_id=ImperialCity
marker_icon=ON-icon-location.png
loadscreen=ON-load-Imperial City 03.jpg
loadtext=At the center of Cyrodiil stands the Imperial City. There, the Three Alliances vie with Daedric overlords and each other for control of the White-Gold Tower.
...
### Imperial Districts
Completing the Objective in each District counts towards for Zone Completion.
- Arboretum
- Arena District
...
### Imperial Sewers
Killing the marked bosses in each section of the Sewers counts towards for Zone Completion.
- Abyssal Depths
...
a giant Bone Colossus found in the Nobles District.
a Grievous Twilight found in the Nobles District.
a Flesh Colossus found in the Arena District.
a flaming Ogrim found in the Temple District.
a Daedroth found in the Arena District.
a Spider Daedra found in the Arboretum District.
a Lich found in the Temple District.
a Frost Atronach found in the Memorial District.
a Clannfear found in the Elven Gardens District.
a Flesh Atronach found in the Memorial District.
a Harvester found in the Arboretum District.
a Watcher found in the Elven Gardens District.
...
## Achievements
- See: Imperial City Achievements

## Notes
- Unlike the rest of Cyrodiil, locations where you have to enter dialogue grant a glowing blue "24 Sanctuary" passive effect. Glowing players from different Alliances can see each other, but can't fight.
- Each rally point in the districts also grant "24 Sanctuary" when standing on the trap door, as well as "24 Chain Pull Range Suppression", "24 Frozen Gate Suppression" and "24 Suppression" effects to the players on the rally point platform. They prevent you from getting attacked by enemies, from getting pulled by many skills, from getting teleported by Frozen Gate and prevents enemies from using Nature Grasp on you which could be used to exploit.
...
- The Imperial City also appears in Arena, Oblivion, Oblivion Mobile, and Legends.
- The city as shown in the Cinematic Trailers more closely resembles the city as it appears in Oblivion than the city as it appears in ESO, with one main bridge leading out of the western district instead of three bridges unattached to the city, and a northeastern district filled with buildings and without a central garden.
