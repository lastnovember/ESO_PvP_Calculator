...
Source: https://en.uesp.net/wiki/Online:Alliance_War
Fetched: 2026-09-12
...
For historical information, see the lore article on the Three Banners War.

## Gameplay

### Campaigns
At the start of the game you will be assigned an alliance based on your race. At Level 10, you will be able to go to Cyrodiil and start participating in a Campaign. These are separate instances of Cyrodiil with their own groups of players, durations and rules. A player can choose one campaign as their "Home Campaign." Alliance Points earned in this campaign are credited towards the end of campaign awards and Alliance War Leaderboards, which can include, gold, jewelry, and transmute crystals. The home campaign can be changed at the end of a campaign or during a campaign at a cost of Alliance Points. Players may enter other campaigns as "Guest Campaigns", which allows players to enter a different instance of Cyrodiil and gain Alliance Points; however their progress in a Guest Campaign will not count towards end of campaign rewards or be recorded on the Alliance War Leaderboards.
...
### Keeps, Resources and Outposts
The main objective within Cyrodiil is to capture Keeps, Resources and Outposts for your alliance, thus increasing your Alliance Points and your alliance's position on the Campaign scoreboard. To capture a location, the attacking alliance must gain entry to its keep using Siege Weapons to destroy the walls or gates, and must then take control of the enemy flags. Keeps and Outposts have two flags in the inner structure, while resources have one flag near the tower. Each alliance general offers a range of repeatable quests designed to direct players through the motions of capturing a keep or resource. Other quests are available from the alliance generals as well, which include scouting out enemy-controlled areas of the map, killing enemy players, and retrieving Elder Scrolls for alliance-wide benefits.
...
Forward Camps are also considered Siege Weapons.
All these items may be purchased from Quartermasters at Keeps as well as received as rewards from Quests, Campaigns, and
Settlement Dailies.

### Imperial City
The Imperial City is divided between the Imperial Sewers, which act as a large PvP-enabled Public Dungeon, and the six Imperial Districts. Each district is a combined close-quarters PvE and PvP area, and has one PvP capture point located on the bridge by the district's inner wall.
...
- Areas that are under the full control of one alliance are indicated with a shield icon.
- Restricted areas, which enemies cannot enter, include the three alliance Border Gates and the Alliance Bases in the Imperial City.
- Protected areas, which are usually safe from enemies except under special circumstances (e.g., a Scroll Temple is not safe if an Artifact Gate is open), include Scroll Temples, Rally Points in the Imperial Districts, and Safe Houses in the AvA Towns.
- Certain areas have PvP disabled within them, while at the same time are still open to all alliances, and these are indicated with the Imperial icon.
...
;The remainder of this section lists the PvP quests in Cyrodiil. For PvE quests, see Cyrodiil Quests. For Imperial City DLC quests, see Imperial City Quests.
