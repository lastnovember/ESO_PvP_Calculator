...
C['enchants'] = OrderedDict(
    ...
    jewelry=OrderedDict(
        **{'Weapon Damage': OrderedDict(magnitude=sourced(174, page('glyphs/Glyph_of_Increase_Physical_Harm.md', 'Truly Superb row, CP160: 134 / 141 / 153 / 160 / 174 white to gold') + '; fixtures 002, 005, 009', 'Glyph of Increase Physical Harm. Grants Weapon and Spell Damage since Update 37: data/patch-notes/html 135 (2023-03-28): Glyph of Physical Harm and Glyph of Spell Harm: These enchantments now grant Weapon and Spell Damage, rather than only Weapon or Spell Damage.'), values=[OrderedDict(stat='weaponDamage', kind='flat'), OrderedDict(stat='spellDamage', kind='flat'), OrderedDict(stat='staminaRecovery', kind='flat', magnitude=sourced(10, pn('135', '2023-03-28', 'Physical Harm glyphs now add 10 Stamina Recovery at all qualities, while Spell Harm glyphs now add 10 Magicka Recovery at all qualities.'), 'Scaled by the Infused jewelry trait like the damage part (16 on a gold Infused piece).'))]),
           ...
           'Potion Cooldown': OrderedDict(magnitude=sourced(5, page('glyphs/Glyph_of_Potion_Speed.md', 'Truly Superb row, CP160: 1 / 2 / 3 / 4 / 5 seconds; the Aspect rune alone sets it white to gold'), 'Seconds off the potion cooldown.'), values=[OrderedDict(stat='potionCooldown', kind='flat', negative=True)]),
           'Potion Boost': OrderedDict(magnitude=sourced(3.6, page('glyphs/Glyph_of_Potion_Boost.md', 'Truly Superb row, CP160: 3.1 / 3.2 / 3.3 / 3.5 / 3.6 seconds white to gold'), 'Seconds added to potion durations.'), values=[OrderedDict(stat='potionDuration', kind='flat')]),
           'Flame Resist': OrderedDict(magnitude=sourced(3520, page('glyphs/Glyph_of_Flame_Resist.md', 'Truly Superb row, CP160: 2708 / 2857 / 3095 / 3250 / 3520 white to gold')), values=[OrderedDict(stat='flameResistance', kind='flat')]),
           'Frost Resist': OrderedDict(magnitude=sourced(3520, page('glyphs/Glyph_of_Frost_Resist.md', 'Truly Superb row, CP160: 2708 / 2857 / 3095 / 3250 / 3520 white to gold')), values=[OrderedDict(stat='frostResistance', kind='flat')]),
           'Shock Resist': OrderedDict(magnitude=sourced(3520, page('glyphs/Glyph_of_Shock_Resist.md', 'Truly Superb row, CP160: 2708 / 2857 / 3095 / 3250 / 3520 white to gold')), values=[OrderedDict(stat='shockResistance', kind='flat')]),
           'Poison Resist': OrderedDict(magnitude=sourced(3520, page('glyphs/Glyph_of_Poison_Resist.md', 'Truly Superb row, CP160: 2708 / 2857 / 3095 / 3250 / 3520 white to gold')), values=[OrderedDict(stat='poisonResistance', kind='flat')]),
           'Disease Resist': OrderedDict(magnitude=sourced(3520, page('glyphs/Glyph_of_Disease_Resist.md', 'Truly Superb row, CP160: 2708 / 2857 / 3095 / 3250 / 3520 white to gold')), values=[OrderedDict(stat='diseaseResistance', kind='flat')]),
           'Decrease Physical Harm': OrderedDict(magnitude=sourced(927, page('glyphs/Glyph_of_Decrease_Physical_Harm.md', 'Truly Superb row, CP160: 713 / 744 / 805 / 856 / 927 white to gold'), 'Adds Physical Resistance (page text).'), values=[OrderedDict(stat='physicalResistance', kind='flat')]),
           'Decrease Spell Harm': OrderedDict(magnitude=sourced(927, page('glyphs/Glyph_of_Decrease_Spell_Harm.md', 'Truly Superb row, CP160: 713 / 744 / 805 / 856 / 927 white to gold'), 'Adds Spell Resistance (page text).'), values=[OrderedDict(stat='spellResistance', kind='flat')])}
    ),
    glyphQualityFactor=OrderedDict(note='Glyph value at each quality relative to gold, from the Truly Superb Glyph of Health row (734 / 774 / 839 / 882 / 954; pages/glyphs/Glyph_of_Health.md and the user\'s table image). Every glyph page scales the same way within rounding. Glyph quality is not a build input yet; the app takes every glyph as gold.', source='glyph table image supplied by the user, 2026-09-19 (engine/tests/fixtures/photos/table-truly-superb-glyph-of-health-by-quality.jpg): Truly Superb Glyph of Health, Repora, CP160: 734 white, 774 green, 839 blue, 882 purple, 954 gold', white=round(734/954, 4), green=round(774/954, 4), blue=round(839/954, 4), purple=round(882/954, 4), gold=1.0),
