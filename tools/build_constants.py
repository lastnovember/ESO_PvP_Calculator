...
C['enchants'] = OrderedDict(
    ...
    armor=OrderedDict(
        **{'Health': OrderedDict(large=sourced(954, 'fixtures 009 and 010 (Dragonknight, seven Glyphs of Health, Sugar Skulls): Max Health 30684 = (16000 + 12 x 122 + 1000 Argonian + 560 Hero\'s Vigor + 1454 Trainee + 3 x 954 + 4 x 385 + 4624) x 1.04 exactly; every other term is pinned by the other three characters, and 954 is twice the Prismatic Defense 477 the same tooltips give. The user reads 984 on the chest, head and legs tooltips and confirms it is not a typo (2026-09-19); with 984 the sheet would be 94 over, so the tooltip and the sheet disagree by 30 per large piece for a reason not in the archive (UNKNOWNS.md).', 'Tooltip reads 984, the sheet sums 954.'), small=sourced(385, 'user, 2026-09-19, gold CP160 tooltips on the Dragonknight (fixtures 009 and 010) and its inventory: every other piece reads 386; the sheet sums 385 (fixture 009 exact with 385, 4 over with 386). Small glyph values truncate on the sheet and round on the tooltip: 954 x 0.4043 = 385.7.'), values=[OrderedDict(stat='maxHealth', kind='flat')]),
