...
C['enchants'] = OrderedDict(
    ...
    jewelry=OrderedDict(
        **{'Weapon Damage': OrderedDict(byQuality=glyph_by_quality('Glyph_of_Increase_Physical_Harm.md', 174), magnitude=sourced(174, page('glyphs/Glyph_of_Increase_Physical_Harm.md', 'Truly Superb row, CP160: 134 / 141 / 153 / 160 / 174 white to gold') + '; fixtures 002, 005, 009', 'Glyph of Increase Physical Harm. Grants Weapon and Spell Damage since Update 37: data/patch-notes/html 135 (2023-03-28): Glyph of Physical Harm and Glyph of Spell Harm: These enchantments now grant Weapon and Spell Damage, rather than only Weapon or Spell Damage.'), values=[OrderedDict(stat='weaponDamage', kind='flat'), OrderedDict(stat='spellDamage', kind='flat'), OrderedDict(stat='staminaRecovery', kind='flat', magnitude=sourced(10, pn('135', '2023-03-28', 'Physical Harm glyphs now add 10 Stamina Recovery at all qualities, while Spell Harm glyphs now add 10 Magicka Recovery at all qualities.'), 'Scaled by the Infused jewelry trait like the damage part (16 on a gold Infused piece).'))]),
           ...
           'Prismatic Recovery': OrderedDict(byQuality=glyph_by_quality('Glyph_of_Prismatic_Recovery.md', 84), magnitude=sourced(84, 'tooltip image supplied by the user, 2026-09-19 (engine/tests/fixtures/photos/tooltip-prismatic-recovery-and-reduce-skill-cost-glyphs.jpg): Truly Superb Glyph of Prismatic Recovery, minimum level CP160, Adds 84 Magicka Recovery, Adds 84 Health Recovery, Adds 84 Stamina Recovery', 'The only sheet reading with this glyph exported (Templar, fixtures 005 and 006) shows no share from the ring: its three recoveries are exact with nothing from it and 84 would read 1517, 1785 and 446 against 1411, 1785 and 415. That ring carries Reduce Skill Cost: the user\'s tooltip of it (engine/tests/fixtures/photos/tooltip-templar-ring1-monomyth-reforged.jpg, 2026-09-19) reads Reduce Prismatic Cost 133, Protective 1190, Monomyth Reforged; fixtures 005 and 006 carry the correction.'), values=[OrderedDict(stat='healthRecovery', kind='flat'), OrderedDict(stat='magickaRecovery', kind='flat'), OrderedDict(stat='staminaRecovery', kind='flat')]),
...
C['sets'] = OrderedDict(
    ...
    bonusByQuality=OrderedDict([
        ...
        ('offensivePenetration', OrderedDict(
            ...
            verified=False,
            note='No Craftable Sets table covers Offensive Penetration. Purple is read (1435, the resistance ratio exactly). Blue is read three times for the same 34-1487 line: 1401 on the Spellshredder Hat (armor) and the Spellshredder Ring (jewelry, photos/tooltip-dk-inventory-spellshredder-ring-blue.jpg), 1400 on the Coup De Grace Restoration Staff (weapon, photos/tooltip-dk-inventory-coup-de-grace-staff-blue.jpg); the resistance ratio gives 1400.53, so whether weapons or the Coup De Grace set differ is not settled. White and green follow the resistance table ratios and are unverified.',
