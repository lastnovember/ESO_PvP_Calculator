...
C['attributePoints'] = OrderedDict(
    ...
    healthPerPoint=unverified(122, 'Max Health granted by one attribute point at level 50.', [111]),
    magickaPerPoint=unverified(111, 'Max Magicka granted by one attribute point at level 50.'),
